...
class HXCPP_CLASS_ATTRIBUTES ModchartAnimateSprite_obj : public  ::flxanimate::FlxAnimate_obj
{
	public:
	...
	public:
		...
		void __construct( ::Dynamic __o_x, ::Dynamic __o_y,::String path, ::Dynamic settings);
		...
		static ::hx::ObjectPtr< ModchartAnimateSprite_obj > __new( ::Dynamic __o_x, ::Dynamic __o_y,::String path, ::Dynamic settings);
		static ::hx::ObjectPtr< ModchartAnimateSprite_obj > __alloc(::hx::Ctx *_hx_ctx, ::Dynamic __o_x, ::Dynamic __o_y,::String path, ::Dynamic settings);
