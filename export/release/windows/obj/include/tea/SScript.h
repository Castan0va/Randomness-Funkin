...
class HXCPP_CLASS_ATTRIBUTES SScript_obj : public ::hx::Object
{
	...
	public:
		...
		static void __boot();
		static  ::Dynamic IGNORE_RETURN;
		static  ::Dynamic STOP_RETURN;
		static  ::Dynamic VERSION;
		static  ::Dynamic defaultTypeCheck;
		static  ::Dynamic defaultDebug;
		...
		static  ::Dynamic set_defaultDebug( ::Dynamic value);
		static ::Dynamic set_defaultDebug_dyn();
		...
		bool traces;
		bool debugTraces;
		 ::haxe::Exception parsingException;
		::String packagePath;
		bool _destroyed;
		void execute();
		::Dynamic execute_dyn();
		...
		::Dynamic setClassString_dyn();
		 ...
		 ::tea::SScript setSpecialObject( ::Dynamic obj, ::Dynamic includeFunctions,::Array< ::String > exclusions);
		::Dynamic setSpecialObject_dyn();
		...
		::Array< ::Dynamic> get_parsingExceptions();
		::Dynamic get_parsingExceptions_dyn();
