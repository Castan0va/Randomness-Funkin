...
class HXCPP_CLASS_ATTRIBUTES Macro_obj : public ::hx::Object
{
	...
	public:
		...
		static void __boot();
		static  ::Dynamic defaultSettings;
		static  ::haxe::ds::StringMap allClassesAvailable;
		static  ::Dynamic VERSION;
		static bool isWindows;
		static ::Array< ::String > credits;
		...
		static ::String get_settingsPath();
		static ::Dynamic get_settingsPath_dyn();
