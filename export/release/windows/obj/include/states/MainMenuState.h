...
class HXCPP_CLASS_ATTRIBUTES MainMenuState_obj : public  ::backend::MusicBeatState_obj
{
	...
	public:
		...
		static int curSelected;
		 ::flixel::FlxSprite randImage;
		 ::flixel::FlxSprite rareblud;
		 ::flixel::FlxSprite logo;
		 ::flixel::FlxSprite topborder;
		 ::flixel::FlxSprite bottomborder;
		 ::flixel::FlxSprite underlay;
		 ::flixel::FlxSprite checker;
		bool specialcheck;
