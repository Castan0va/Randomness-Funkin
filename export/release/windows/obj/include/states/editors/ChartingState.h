...
class HXCPP_CLASS_ATTRIBUTES ChartingState_obj : public  ::backend::MusicBeatState_obj
{
	...
	public:
		...
		void create();
		 ...
		 ::flixel::addons::ui::FlxUICheckBox check_mute_vocals_opponent;
		...
		::Dynamic setAllLabelsOffset_dyn();
		 ...
		 ::flixel::addons::ui::FlxUINumericStepper voicesOppVolume;
		void addChartingUI();
		...
		void pauseAndSetVocalsTime();
		::Dynamic pauseAndSetVocalsTime_dyn();
