...
class Token_obj : public ::hx::EnumBase_obj
{
	...
	public:
		...
		static ::hscriptBase::Token TQDot;
		static inline ::hscriptBase::Token TQDot_dyn() { return TQDot; }
		static ::hscriptBase::Token TQDouble;
		static inline ::hscriptBase::Token TQDouble_dyn() { return TQDouble; }
		static ::hscriptBase::Token TQDoubleAssign;
		static inline ::hscriptBase::Token TQDoubleAssign_dyn() { return TQDoubleAssign; }
