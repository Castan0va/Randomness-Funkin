...
class HXCPP_CLASS_ATTRIBUTES Parser_obj : public ::hx::Object
{
	...
	public:
		...
		static void __boot();
		static ::Array< ::String > notAllowedFieldNames;
		static ::String constString( ::hscriptBase::Const c);
		static ::Dynamic constString_dyn();

		static ::String tokenString( ::hscriptBase::Token t);
		static ::Dynamic tokenString_dyn();
		...
		::Dynamic makeBinop_dyn();
		 ...
		 ::Dynamic parseStructure(::String id, ::Dynamic d);
