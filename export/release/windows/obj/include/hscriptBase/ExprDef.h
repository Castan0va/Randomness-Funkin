...
class ExprDef_obj : public ::hx::EnumBase_obj
{
	...
	public:
		...
		static ::hscriptBase::ExprDef EFinal(::String f, ::hscriptBase::CType t, ::Dynamic e);
		static ::Dynamic EFinal_dyn();
		static ::hscriptBase::ExprDef EFor(::String v, ::Dynamic it, ::Dynamic e);
		static ::Dynamic EFor_dyn();
		static ::hscriptBase::ExprDef EFunction(::Array< ::Dynamic> args, ::Dynamic e,::String name, ::hscriptBase::CType ret, ::Dynamic d);
		...
		static ::hscriptBase::ExprDef EImport( ::Dynamic i,::String c,::String asIdent);
		static ::Dynamic EImport_dyn();
		static ::hscriptBase::ExprDef EImportStar(::String pkg);
		static ::Dynamic EImportStar_dyn();
		static ::hscriptBase::ExprDef EMeta(::String name,::Array< ::Dynamic> args, ::Dynamic e);
		static ::Dynamic EMeta_dyn();
		static ::hscriptBase::ExprDef ENew(::String cl,::Array< ::Dynamic> params,::Array< ::String > subIds);
		...
		static ::hscriptBase::ExprDef ESafeNavigator( ::Dynamic e1,::String f);
		static ::Dynamic ESafeNavigator_dyn();
		static ::hscriptBase::ExprDef ESwitch( ::Dynamic e,::Array< ::Dynamic> cases, ::Dynamic defaultExpr);
		static ::Dynamic ESwitch_dyn();
		static ::hscriptBase::ExprDef ESwitchBinop( ::Dynamic p, ::Dynamic e1, ::Dynamic e2);
		static ::Dynamic ESwitchBinop_dyn();
		...
		static ::hscriptBase::ExprDef EVar(::String n, ::hscriptBase::CType t, ::Dynamic e,::Array< ::String > g);
