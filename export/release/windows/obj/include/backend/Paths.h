...
class HXCPP_CLASS_ATTRIBUTES Paths_obj : public ::hx::Object
{
	...
	public:
		...
		static  ::Dynamic voices(::String song,::String postfix);
		...
		static  ::flixel::graphics::FlxGraphic cacheBitmap(::String file, ::openfl::display::BitmapData bitmap, ::Dynamic allowGPU);
		...
		static  ::flixel::graphics::frames::FlxAtlasFrames getAtlas(::String key,::String library, ::Dynamic allowGPU);
		...
		static  ::flixel::graphics::frames::FlxAtlasFrames getAsepriteAtlas(::String key,::String library, ::Dynamic allowGPU);
		...
		static void loadAnimateAtlas( ::flxanimate::FlxAnimate spr, ::Dynamic folderOrImg, ::Dynamic spriteJson, ::Dynamic animationJson);
