...
HX_DECLARE_STACK_FRAME(_hx_pos_db09ff2b98ac40f1_33_new)
...
HXLINE(  51)		( ( ::backend::Song)(__this) )->gfVersion = HX_("gf",1f,5a,00,00);
HXLINE(  50)		( ( ::backend::Song)(__this) )->player2 = HX_("dad",47,36,4c,00);
HXLINE(  49)		( ( ::backend::Song)(__this) )->player1 = HX_("bf",c4,55,00,00);
HXLINE(  47)		( ( ::backend::Song)(__this) )->speed = ((Float)1);
HXLINE(  46)		( ( ::backend::Song)(__this) )->disableNoteRGB = false;
HXLINE(  39)		( ( ::backend::Song)(__this) )->needsVoices = true;
HXLINE(  88)		( ( ::backend::Song)(__this) )->song = song;
HXLINE(  89)		( ( ::backend::Song)(__this) )->notes = notes;
HXLINE(  90)		( ( ::backend::Song)(__this) )->bpm = bpm;
            	}
