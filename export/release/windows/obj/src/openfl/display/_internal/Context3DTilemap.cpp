...
HXDLIN( 257)								 ::__hxcpp_memory_set_float(this17->buffer->b,(this17->byteOffset + (((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i)) + alphaPosition) * 4)),alpha);
            							}
            						}
            					}
...
HXDLIN( 265)							while((_g2 < 4)){
HXLINE( 265)								_g2 = (_g2 + 1);
HXDLIN( 265)								int i1 = (_g2 - 1);
HXLINE( 267)								{
HXLINE( 267)									 ::lime::utils::ArrayBufferView this18 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 267)									Float val = colorTransform->redMultiplier;
HXDLIN( 267)									 ::__hxcpp_memory_set_float(this18->buffer->b,(this18->byteOffset + (((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i1)) + ctPosition) * 4)),val);
            								}
HXLINE( 268)								{
HXLINE( 268)									 ::lime::utils::ArrayBufferView this19 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 268)									Float val1 = colorTransform->greenMultiplier;
HXDLIN( 268)									 ::__hxcpp_memory_set_float(this19->buffer->b,(this19->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i1)) + ctPosition) + 1) * 4)),val1);
            								}
HXLINE( 269)								{
HXLINE( 269)									 ::lime::utils::ArrayBufferView this20 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 269)									Float val2 = colorTransform->blueMultiplier;
HXDLIN( 269)									 ::__hxcpp_memory_set_float(this20->buffer->b,(this20->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i1)) + ctPosition) + 2) * 4)),val2);
            								}
HXLINE( 270)								{
HXLINE( 270)									 ::lime::utils::ArrayBufferView this21 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 270)									Float val3 = colorTransform->alphaMultiplier;
HXDLIN( 270)									 ::__hxcpp_memory_set_float(this21->buffer->b,(this21->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i1)) + ctPosition) + 3) * 4)),val3);
            								}
HXLINE( 272)								{
HXLINE( 272)									 ::lime::utils::ArrayBufferView this22 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 272)									Float val4 = colorTransform->redOffset;
HXDLIN( 272)									 ::__hxcpp_memory_set_float(this22->buffer->b,(this22->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i1)) + ctPosition) + 4) * 4)),val4);
            								}
HXLINE( 273)								{
HXLINE( 273)									 ::lime::utils::ArrayBufferView this23 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 273)									Float val5 = colorTransform->greenOffset;
HXDLIN( 273)									 ::__hxcpp_memory_set_float(this23->buffer->b,(this23->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i1)) + ctPosition) + 5) * 4)),val5);
            								}
HXLINE( 274)								{
HXLINE( 274)									 ::lime::utils::ArrayBufferView this24 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 274)									Float val6 = colorTransform->blueOffset;
HXDLIN( 274)									 ::__hxcpp_memory_set_float(this24->buffer->b,(this24->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i1)) + ctPosition) + 6) * 4)),val6);
            								}
HXLINE( 275)								{
HXLINE( 275)									 ::lime::utils::ArrayBufferView this25 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 275)									Float val7 = colorTransform->alphaOffset;
HXDLIN( 275)									 ::__hxcpp_memory_set_float(this25->buffer->b,(this25->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i1)) + ctPosition) + 7) * 4)),val7);
            								}
            							}
            						}
            						else {
HXLINE( 280)							int _g3 = 0;
HXDLIN( 280)							while((_g3 < 4)){
HXLINE( 280)								_g3 = (_g3 + 1);
HXDLIN( 280)								int i2 = (_g3 - 1);
HXLINE( 282)								{
HXLINE( 282)									 ::lime::utils::ArrayBufferView this26 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 282)									 ::__hxcpp_memory_set_float(this26->buffer->b,(this26->byteOffset + (((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i2)) + ctPosition) * 4)),1);
            								}
HXLINE( 283)								{
HXLINE( 283)									 ::lime::utils::ArrayBufferView this27 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 283)									 ::__hxcpp_memory_set_float(this27->buffer->b,(this27->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i2)) + ctPosition) + 1) * 4)),1);
            								}
HXLINE( 284)								{
HXLINE( 284)									 ::lime::utils::ArrayBufferView this28 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 284)									 ::__hxcpp_memory_set_float(this28->buffer->b,(this28->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i2)) + ctPosition) + 2) * 4)),1);
            								}
HXLINE( 285)								{
HXLINE( 285)									 ::lime::utils::ArrayBufferView this29 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 285)									 ::__hxcpp_memory_set_float(this29->buffer->b,(this29->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i2)) + ctPosition) + 3) * 4)),1);
            								}
HXLINE( 287)								{
HXLINE( 287)									 ::lime::utils::ArrayBufferView this30 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 287)									 ::__hxcpp_memory_set_float(this30->buffer->b,(this30->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i2)) + ctPosition) + 4) * 4)),0);
            								}
HXLINE( 288)								{
HXLINE( 288)									 ::lime::utils::ArrayBufferView this31 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 288)									 ::__hxcpp_memory_set_float(this31->buffer->b,(this31->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i2)) + ctPosition) + 5) * 4)),0);
            								}
HXLINE( 289)								{
HXLINE( 289)									 ::lime::utils::ArrayBufferView this32 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 289)									 ::__hxcpp_memory_set_float(this32->buffer->b,(this32->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i2)) + ctPosition) + 6) * 4)),0);
            								}
HXLINE( 290)								{
HXLINE( 290)									 ::lime::utils::ArrayBufferView this33 = ::openfl::display::_internal::Context3DTilemap_obj::vertexBufferData;
HXDLIN( 290)									 ::__hxcpp_memory_set_float(this33->buffer->b,(this33->byteOffset + ((((vertexOffset + (::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex * i2)) + ctPosition) + 7) * 4)),0);
            								}
            							}
            						}
            					}
