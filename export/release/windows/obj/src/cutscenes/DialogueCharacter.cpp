...
HXDLIN(  46)		 ::flixel::graphics::FlxGraphic imageLoaded = ::backend::Paths_obj::image(key,library,true);
...
HXLINE(  46)			_hx_tmp = ::backend::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e)),null(),library,null());
            		}
...
HXLINE(  81)				this->animation->addByPrefix(( (::String)((anim->__Field(HX_("anim",11,86,71,40),::hx::paccDynamic) + ::cutscenes::DialogueCharacter_obj::IDLE_SUFFIX)) ),( (::String)(anim->__Field(HX_("idle_name",96,be,e2,c5),::hx::paccDynamic)) ),24,true,null(),null());
...
HXLINE( 105)			_hx_tmp4 = (leAnim + ::cutscenes::DialogueCharacter_obj::IDLE_SUFFIX);
            		}
            		else {
...
HXLINE( 124)		return !(::StringTools_obj::endsWith(this->animation->_curAnim->name,::cutscenes::DialogueCharacter_obj::IDLE_SUFFIX));
            	}
...
HXDLIN(  26)		IDLE_SUFFIX = HX_("-IDLE",c1,89,7c,19);
            	}
{
