...
HXLINE(  54)			 ::flixel::FlxSprite _hx_tmp2 = this->box;
HXDLIN(  54)			::String library = null();
HXDLIN(  54)			 ::flixel::graphics::FlxGraphic imageLoaded = ::backend::Paths_obj::image(HX_("weeb/pixelUI/dialogueBox-senpaiMad",61,55,ee,84),library,true);
...
HXDLIN(  54)			 ::Dynamic _hx_tmp3;
HXDLIN(  54)			if (xmlExists) {
HXLINE(  54)				_hx_tmp3 = ::sys::io::File_obj::getContent(xml);
            			}
            			else {
HXLINE(  54)				_hx_tmp3 = ::backend::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/pixelUI/dialogueBox-senpaiMad",61,55,ee,84)) + HX_(".xml",69,3e,c3,1e)),null(),library,null());
            			}
HXDLIN(  54)			_hx_tmp2->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(imageLoaded,_hx_tmp3));
...
HXLINE(  50)			 ::flixel::FlxSprite _hx_tmp4 = this->box;
HXDLIN(  50)			::String library1 = null();
HXDLIN(  50)			 ::flixel::graphics::FlxGraphic imageLoaded1 = ::backend::Paths_obj::image(HX_("weeb/pixelUI/dialogueBox-pixel",b3,f0,21,da),library1,true);
HXDLIN(  50)			bool xmlExists1 = false;
HXDLIN(  50)			::String xml1 = ::backend::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + HX_("weeb/pixelUI/dialogueBox-pixel",b3,f0,21,da)) + HX_(".xml",69,3e,c3,1e)));
HXDLIN(  50)			if (::sys::FileSystem_obj::exists(xml1)) {
HXLINE(  50)				xmlExists1 = true;
            			}
HXDLIN(  50)			 ::Dynamic _hx_tmp5;
HXDLIN(  50)			if (xmlExists1) {
HXLINE(  50)				_hx_tmp5 = ::sys::io::File_obj::getContent(xml1);
            			}
            			else {
HXLINE(  50)				_hx_tmp5 = ::backend::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/pixelUI/dialogueBox-pixel",b3,f0,21,da)) + HX_(".xml",69,3e,c3,1e)),null(),library1,null());
            			}
HXDLIN(  50)			_hx_tmp4->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(imageLoaded1,_hx_tmp5));
...
HXLINE(  58)			 ::flixel::FlxSprite _hx_tmp6 = this->box;
HXDLIN(  58)			::String library2 = null();
HXDLIN(  58)			 ::flixel::graphics::FlxGraphic imageLoaded2 = ::backend::Paths_obj::image(HX_("weeb/pixelUI/dialogueBox-evil",07,6d,f9,cc),library2,true);
HXDLIN(  58)			bool xmlExists2 = false;
HXDLIN(  58)			::String xml2 = ::backend::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + HX_("weeb/pixelUI/dialogueBox-evil",07,6d,f9,cc)) + HX_(".xml",69,3e,c3,1e)));
HXDLIN(  58)			if (::sys::FileSystem_obj::exists(xml2)) {
HXLINE(  58)				xmlExists2 = true;
            			}
HXDLIN(  58)			 ::Dynamic _hx_tmp7;
HXDLIN(  58)			if (xmlExists2) {
HXLINE(  58)				_hx_tmp7 = ::sys::io::File_obj::getContent(xml2);
            			}
            			else {
HXLINE(  58)				_hx_tmp7 = ::backend::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/pixelUI/dialogueBox-evil",07,6d,f9,cc)) + HX_(".xml",69,3e,c3,1e)),null(),library2,null());
            			}
HXDLIN(  58)			_hx_tmp6->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(imageLoaded2,_hx_tmp7));
...
HXLINE(  75)		 ::flixel::FlxSprite _hx_tmp8 = this->portraitLeft;
HXDLIN(  75)		::String library3 = null();
HXDLIN(  75)		 ::flixel::graphics::FlxGraphic imageLoaded3 = ::backend::Paths_obj::image(HX_("weeb/senpaiPortrait",9b,ed,4f,6d),library3,true);
HXDLIN(  75)		bool xmlExists3 = false;
HXDLIN(  75)		::String xml3 = ::backend::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + HX_("weeb/senpaiPortrait",9b,ed,4f,6d)) + HX_(".xml",69,3e,c3,1e)));
HXDLIN(  75)		if (::sys::FileSystem_obj::exists(xml3)) {
HXLINE(  75)			xmlExists3 = true;
            		}
HXDLIN(  75)		 ::Dynamic _hx_tmp9;
HXDLIN(  75)		if (xmlExists3) {
HXLINE(  75)			_hx_tmp9 = ::sys::io::File_obj::getContent(xml3);
            		}
            		else {
HXLINE(  75)			_hx_tmp9 = ::backend::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/senpaiPortrait",9b,ed,4f,6d)) + HX_(".xml",69,3e,c3,1e)),null(),library3,null());
            		}
HXDLIN(  75)		_hx_tmp8->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(imageLoaded3,_hx_tmp9));
...
HXLINE(  77)		 ::flixel::FlxSprite _hx_tmp10 = this->portraitLeft;
HXDLIN(  77)		Float _hx_tmp11 = this->portraitLeft->get_width();
HXDLIN(  77)		_hx_tmp10->setGraphicSize(::Std_obj::_hx_int(((_hx_tmp11 * ::states::PlayState_obj::daPixelZoom) * ((Float)0.9))),null());
...
HXLINE(  84)		 ::flixel::FlxSprite _hx_tmp12 = this->portraitRight;
HXDLIN(  84)		::String library4 = null();
HXDLIN(  84)		 ::flixel::graphics::FlxGraphic imageLoaded4 = ::backend::Paths_obj::image(HX_("weeb/bfPortrait",23,ea,7a,a3),library4,true);
HXDLIN(  84)		bool xmlExists4 = false;
HXDLIN(  84)		::String xml4 = ::backend::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + HX_("weeb/bfPortrait",23,ea,7a,a3)) + HX_(".xml",69,3e,c3,1e)));
HXDLIN(  84)		if (::sys::FileSystem_obj::exists(xml4)) {
HXLINE(  84)			xmlExists4 = true;
            		}
HXDLIN(  84)		 ::Dynamic _hx_tmp13;
HXDLIN(  84)		if (xmlExists4) {
HXLINE(  84)			_hx_tmp13 = ::sys::io::File_obj::getContent(xml4);
            		}
            		else {
HXLINE(  84)			_hx_tmp13 = ::backend::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/bfPortrait",23,ea,7a,a3)) + HX_(".xml",69,3e,c3,1e)),null(),library4,null());
            		}
HXDLIN(  84)		_hx_tmp12->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(imageLoaded4,_hx_tmp13));
...
HXLINE(  86)		 ::flixel::FlxSprite _hx_tmp14 = this->portraitRight;
HXDLIN(  86)		Float _hx_tmp15 = this->portraitRight->get_width();
HXDLIN(  86)		_hx_tmp14->setGraphicSize(::Std_obj::_hx_int(((_hx_tmp15 * ::states::PlayState_obj::daPixelZoom) * ((Float)0.9))),null());
...
HXLINE(  93)		 ::flixel::FlxSprite _hx_tmp16 = this->box;
HXDLIN(  93)		Float _hx_tmp17 = this->box->get_width();
HXDLIN(  93)		_hx_tmp16->setGraphicSize(::Std_obj::_hx_int(((_hx_tmp17 * ::states::PlayState_obj::daPixelZoom) * ((Float)0.9))),null());
HXLINE(  94)		this->box->updateHitbox();
HXLINE(  95)		this->add(this->box);
HXLINE(  97)		{
HXLINE(  97)			 ::flixel::FlxSprite _this = this->box;
HXDLIN(  97)			int axes = 1;
HXDLIN(  97)			bool _hx_tmp18;
HXDLIN(  97)			if ((axes != 1)) {
HXLINE(  97)				_hx_tmp18 = (axes == 17);
            			}
            			else {
HXLINE(  97)				_hx_tmp18 = true;
            			}
HXDLIN(  97)			if (_hx_tmp18) {
HXLINE(  97)				int _hx_tmp19 = ::flixel::FlxG_obj::width;
HXDLIN(  97)				_this->set_x(((( (Float)(_hx_tmp19) ) - _this->get_width()) / ( (Float)(2) )));
            			}
HXDLIN(  97)			bool _hx_tmp20;
HXDLIN(  97)			if ((axes != 16)) {
HXLINE(  97)				_hx_tmp20 = (axes == 17);
            			}
            			else {
HXLINE(  97)				_hx_tmp20 = true;
            			}
HXDLIN(  97)			if (_hx_tmp20) {
HXLINE(  97)				int _hx_tmp21 = ::flixel::FlxG_obj::height;
HXDLIN(  97)				_this->set_y(((( (Float)(_hx_tmp21) ) - _this->get_height()) / ( (Float)(2) )));
            			}
            		}
HXLINE(  98)		{
HXLINE(  98)			 ::flixel::FlxSprite _this1 = this->portraitLeft;
HXDLIN(  98)			int axes1 = 1;
HXDLIN(  98)			bool _hx_tmp22;
HXDLIN(  98)			if ((axes1 != 1)) {
HXLINE(  98)				_hx_tmp22 = (axes1 == 17);
            			}
            			else {
HXLINE(  98)				_hx_tmp22 = true;
            			}
HXDLIN(  98)			if (_hx_tmp22) {
HXLINE(  98)				int _hx_tmp23 = ::flixel::FlxG_obj::width;
HXDLIN(  98)				_this1->set_x(((( (Float)(_hx_tmp23) ) - _this1->get_width()) / ( (Float)(2) )));
            			}
HXDLIN(  98)			bool _hx_tmp24;
HXDLIN(  98)			if ((axes1 != 16)) {
HXLINE(  98)				_hx_tmp24 = (axes1 == 17);
            			}
            			else {
HXLINE(  98)				_hx_tmp24 = true;
            			}
HXDLIN(  98)			if (_hx_tmp24) {
HXLINE(  98)				int _hx_tmp25 = ::flixel::FlxG_obj::height;
HXDLIN(  98)				_this1->set_y(((( (Float)(_hx_tmp25) ) - _this1->get_height()) / ( (Float)(2) )));
            			}
            		}
HXLINE( 100)		 ::flixel::FlxSprite _hx_tmp26 =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,1042,590,null());
HXDLIN( 100)		this->handSelect = _hx_tmp26->loadGraphic(::backend::Paths_obj::image(HX_("weeb/pixelUI/hand_textbox",67,1b,cd,60),null(),null()),null(),null(),null(),null(),null());
HXLINE( 101)		 ::flixel::FlxSprite _hx_tmp27 = this->handSelect;
HXDLIN( 101)		Float _hx_tmp28 = this->handSelect->get_width();
HXDLIN( 101)		_hx_tmp27->setGraphicSize(::Std_obj::_hx_int(((_hx_tmp28 * ::states::PlayState_obj::daPixelZoom) * ((Float)0.9))),null());
HXLINE( 102)		this->handSelect->updateHitbox();
HXLINE( 103)		this->handSelect->set_visible(false);
HXLINE( 104)		this->add(this->handSelect);
HXLINE( 107)		bool _hx_tmp29 = !(talkingRight);
...
HXLINE( 120)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp30 = ::flixel::FlxG_obj::sound;
HXDLIN( 120)		 ::flixel::sound::FlxSound _hx_tmp31 = _hx_tmp30->load(::backend::Paths_obj::sound(HX_("pixelText",53,7a,83,06),null()),((Float)0.6),null(),null(),null(),null(),null(),null(),null());
HXDLIN( 120)		this->swagDialogue->sounds = ::Array_obj< ::Dynamic>::__new(1)->init(0,_hx_tmp31);
...
HXLINE( 151)			_hx_tmp1 = !(this->dialogueStarted);
            		}
            		else {
...
HXLINE( 161)					_hx_tmp2 = ::hx::IsNotNull( this->dialogueList->__get(0) );
            				}
            				else {
...
HXLINE( 166)						 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp3 = ::flixel::FlxG_obj::sound;
HXDLIN( 166)						_hx_tmp3->play(::backend::Paths_obj::sound(HX_("clickText",15,39,f9,2b),null()),((Float)0.8),null(),null(),null(),null());
...
HXLINE( 168)							_hx_tmp4 = (( (::String)(::states::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ).toLowerCase() == HX_("thorns",9c,bf,c7,8c));
            						}
            						else {
...
HXLINE( 193)					 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp5 = ::flixel::FlxG_obj::sound;
HXDLIN( 193)					_hx_tmp5->play(::backend::Paths_obj::sound(HX_("clickText",15,39,f9,2b),null()),((Float)0.8),null(),null(),null(),null());
            				}
            			}
            			else {
HXLINE( 196)				if (this->dialogueStarted) {
HXLINE( 198)					 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp6 = ::flixel::FlxG_obj::sound;
HXDLIN( 198)					_hx_tmp6->play(::backend::Paths_obj::sound(HX_("clickText",15,39,f9,2b),null()),((Float)0.8),null(),null(),null(),null());
