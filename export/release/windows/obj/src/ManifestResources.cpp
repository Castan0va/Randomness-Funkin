...
HXLINE(  71)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_pixel_otf >());
...
HXLINE(  80)		{
HXLINE(  80)			::String v = (::ManifestResources_obj::rootPath + HX_("manifest/songs.json",38,27,75,ee));
HXDLIN(  80)			::lime::utils::Assets_obj::libraryPaths->set(HX_("songs",fe,36,c7,80),v);
            		}
HXLINE(  81)		{
HXLINE(  81)			::String v1 = (::ManifestResources_obj::rootPath + HX_("manifest/week_assets.json",88,97,37,e3));
HXDLIN(  81)			::lime::utils::Assets_obj::libraryPaths->set(HX_("week_assets",ae,a0,93,a0),v1);
            		}
HXLINE(  82)		{
HXLINE(  82)			::String v2 = (::ManifestResources_obj::rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN(  82)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v2);
            		}
HXLINE(  78)		 ::lime::utils::AssetLibrary library = ::lime::utils::Assets_obj::getLibrary(HX_("songs",fe,36,c7,80));
...
HXLINE(  88)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week_assets",ae,a0,93,a0));
HXLINE(  89)		if (::hx::IsNotNull( library )) {
HXLINE(  89)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  90)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week_assets",ae,a0,93,a0));
            		}
