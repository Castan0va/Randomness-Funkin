...
HX_LOCAL_STACK_FRAME(_hx_pos_3e78deb4e15a8a4d_120_startCountdown,"backend.BaseStage","startCountdown",0xad14a20a,"backend.BaseStage.startCountdown","backend/BaseStage.hx",120,0x8865de2c)
HX_LOCAL_STACK_FRAME(_hx_pos_3e78deb4e15a8a4d_121_endSong,"backend.BaseStage","endSong",0xf7d6a5d5,"backend.BaseStage.endSong","backend/BaseStage.hx",121,0x8865de2c)
HX_LOCAL_STACK_FRAME(_hx_pos_3e78deb4e15a8a4d_122_moveCameraSection,"backend.BaseStage","moveCameraSection",0x51c6ccb4,"backend.BaseStage.moveCameraSection","backend/BaseStage.hx",122,0x8865de2c)
HX_LOCAL_STACK_FRAME(_hx_pos_3e78deb4e15a8a4d_123_moveCamera,"backend.BaseStage","moveCamera",0x66975931,"backend.BaseStage.moveCamera","backend/BaseStage.hx",123,0x8865de2c)
HX_LOCAL_STACK_FRAME(_hx_pos_3e78deb4e15a8a4d_124_get_paused,"backend.BaseStage","get_paused",0x3ee84912,"backend.BaseStage.get_paused","backend/BaseStage.hx",124,0x8865de2c)
HX_LOCAL_STACK_FRAME(_hx_pos_3e78deb4e15a8a4d_125_get_songName,"backend.BaseStage","get_songName",0x2d99ba24,"backend.BaseStage.get_songName","backend/BaseStage.hx",125,0x8865de2c)
HX_LOCAL_STACK_FRAME(_hx_pos_3e78deb4e15a8a4d_126_get_isStoryMode,"backend.BaseStage","get_isStoryMode",0x43b175ca,"backend.BaseStage.get_isStoryMode","backend/BaseStage.hx",126,0x8865de2c)
HX_LOCAL_STACK_FRAME(_hx_pos_3e78deb4e15a8a4d_127_get_seenCutscene,"backend.BaseStage","get_seenCutscene",0x92123c89,"backend.BaseStage.get_seenCutscene","backend/BaseStage.hx",127,0x8865de2c)
HX_LOCAL_STACK_FRAME(_hx_pos_3e78deb4e15a8a4d_128_get_inCutscene,"backend.BaseStage","get_inCutscene",0xf01b2bf3,"backend.BaseStage.get_inCutscene","backend/BaseStage.hx",128,0x8865de2c)
HX_LOCAL_STACK_FRAME(_hx_pos_3e78deb4e15a8a4d_130_set_inCutscene,"backend.BaseStage","set_inCutscene",0x103b1467,"backend.BaseStage.set_inCutscene","backend/BaseStage.hx",130,0x8865de2c)
HX_LOCAL_STACK_FRAME(_hx_pos_3e78deb4e15a8a4d_134_get_canPause,"backend.BaseStage","get_canPause",0x22ad022a,"backend.BaseStage.get_canPause","backend/BaseStage.hx",134,0x8865de2c)
HX_LOCAL_STACK_FRAME(_hx_pos_3e78deb4e15a8a4d_136_set_canPause,"backend.BaseStage","set_canPause",0x37a6259e,"backend.BaseStage.set_canPause","backend/BaseStage.hx",136,0x8865de2c)
HX_LOCAL_STACK_FRAME(_hx_pos_3e78deb4e15a8a4d_140_get_members,"backend.BaseStage","get_members",0x42937bf5,"backend.BaseStage.get_members","backend/BaseStage.hx",140,0x8865de2c)
HX_LOCAL_STACK_FRAME(_hx_pos_3e78deb4e15a8a4d_142_set_game,"backend.BaseStage","set_game",0xd7acb4ca,"backend.BaseStage.set_game","backend/BaseStage.hx",142,0x8865de2c)
HX_LOCAL_STACK_FRAME(_hx_pos_3e78deb4e15a8a4d_148_get_boyfriend,"backend.BaseStage","get_boyfriend",0xd9a27786,"backend.BaseStage.get_boyfriend","backend/BaseStage.hx",148,0x8865de2c)
HX_LOCAL_STACK_FRAME(_hx_pos_3e78deb4e15a8a4d_149_get_dad,"backend.BaseStage","get_dad",0xf01ac763,"backend.BaseStage.get_dad","backend/BaseStage.hx",149,0x8865de2c)
HX_LOCAL_STACK_FRAME(_hx_pos_3e78deb4e15a8a4d_150_get_gf,"backend.BaseStage","get_gf",0xdc576083,"backend.BaseStage.get_gf","backend/BaseStage.hx",150,0x8865de2c)
HX_LOCAL_STACK_FRAME(_hx_pos_3e78deb4e15a8a4d_152_get_boyfriendGroup,"backend.BaseStage","get_boyfriendGroup",0x3402a5d9,"backend.BaseStage.get_boyfriendGroup","backend/BaseStage.hx",152,0x8865de2c)
HX_LOCAL_STACK_FRAME(_hx_pos_3e78deb4e15a8a4d_153_get_dadGroup,"backend.BaseStage","get_dadGroup",0x38eab4dc,"backend.BaseStage.get_dadGroup","backend/BaseStage.hx",153,0x8865de2c)
HX_LOCAL_STACK_FRAME(_hx_pos_3e78deb4e15a8a4d_154_get_gfGroup,"backend.BaseStage","get_gfGroup",0xd8cf07bc,"backend.BaseStage.get_gfGroup","backend/BaseStage.hx",154,0x8865de2c)
HX_LOCAL_STACK_FRAME(_hx_pos_3e78deb4e15a8a4d_156_get_camGame,"backend.BaseStage","get_camGame",0xf77396bd,"backend.BaseStage.get_camGame","backend/BaseStage.hx",156,0x8865de2c)
HX_LOCAL_STACK_FRAME(_hx_pos_3e78deb4e15a8a4d_157_get_camHUD,"backend.BaseStage","get_camHUD",0x06da344c,"backend.BaseStage.get_camHUD","backend/BaseStage.hx",157,0x8865de2c)
HX_LOCAL_STACK_FRAME(_hx_pos_3e78deb4e15a8a4d_158_get_camOther,"backend.BaseStage","get_camOther",0x357035a5,"backend.BaseStage.get_camOther","backend/BaseStage.hx",158,0x8865de2c)
HX_LOCAL_STACK_FRAME(_hx_pos_3e78deb4e15a8a4d_160_get_defaultCamZoom,"backend.BaseStage","get_defaultCamZoom",0x50235c65,"backend.BaseStage.get_defaultCamZoom","backend/BaseStage.hx",160,0x8865de2c)
HX_LOCAL_STACK_FRAME(_hx_pos_3e78deb4e15a8a4d_162_set_defaultCamZoom,"backend.BaseStage","set_defaultCamZoom",0x2cd28ed9,"backend.BaseStage.set_defaultCamZoom","backend/BaseStage.hx",162,0x8865de2c)
HX_LOCAL_STACK_FRAME(_hx_pos_3e78deb4e15a8a4d_166_get_camFollow,"backend.BaseStage","get_camFollow",0x1531bcfc,"backend.BaseStage.get_camFollow","backend/BaseStage.hx",166,0x8865de2c)
namespace backend{
...
HXLINE(  53)			::flixel::FlxG_obj::log->advanced(HX_("Invalid state for the stage added!",a1,b3,bb,29),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
...
bool BaseStage_obj::startCountdown(){
            	HX_STACKFRAME(&_hx_pos_3e78deb4e15a8a4d_120_startCountdown)
HXDLIN( 120)		if (this->onPlayState) {
HXDLIN( 120)			return ::states::PlayState_obj::instance->startCountdown();
            		}
            		else {
...
bool BaseStage_obj::endSong(){
            	HX_STACKFRAME(&_hx_pos_3e78deb4e15a8a4d_121_endSong)
HXDLIN( 121)		if (this->onPlayState) {
HXDLIN( 121)			return ::states::PlayState_obj::instance->endSong();
            		}
            		else {
...
void BaseStage_obj::moveCameraSection(){
            	HX_STACKFRAME(&_hx_pos_3e78deb4e15a8a4d_122_moveCameraSection)
HXDLIN( 122)		if (this->onPlayState) {
HXDLIN( 122)			this->moveCameraSection();
            		}
            	}
...
void BaseStage_obj::moveCamera(bool isDad){
            	HX_STACKFRAME(&_hx_pos_3e78deb4e15a8a4d_123_moveCamera)
HXDLIN( 123)		if (this->onPlayState) {
HXDLIN( 123)			this->moveCamera(isDad);
            		}
            	}
...
bool BaseStage_obj::get_paused(){
            	HX_STACKFRAME(&_hx_pos_3e78deb4e15a8a4d_124_get_paused)
HXDLIN( 124)		return ( (bool)(this->game->__Field(HX_("paused",ae,40,84,ef),::hx::paccDynamic)) );
            	}
...
::String BaseStage_obj::get_songName(){
            	HX_STACKFRAME(&_hx_pos_3e78deb4e15a8a4d_125_get_songName)
HXDLIN( 125)		return ( (::String)(this->game->__Field(HX_("songName",c0,d0,d7,36),::hx::paccDynamic)) );
            	}
...
bool BaseStage_obj::get_isStoryMode(){
            	HX_STACKFRAME(&_hx_pos_3e78deb4e15a8a4d_126_get_isStoryMode)
HXDLIN( 126)		return ::states::PlayState_obj::isStoryMode;
            	}
...
bool BaseStage_obj::get_seenCutscene(){
            	HX_STACKFRAME(&_hx_pos_3e78deb4e15a8a4d_127_get_seenCutscene)
HXDLIN( 127)		return ::states::PlayState_obj::seenCutscene;
            	}
...
bool BaseStage_obj::get_inCutscene(){
            	HX_STACKFRAME(&_hx_pos_3e78deb4e15a8a4d_128_get_inCutscene)
HXDLIN( 128)		return ( (bool)(this->game->__Field(HX_("inCutscene",8f,21,01,56),::hx::paccDynamic)) );
            	}
...
bool BaseStage_obj::set_inCutscene(bool value){
            	HX_STACKFRAME(&_hx_pos_3e78deb4e15a8a4d_130_set_inCutscene)
HXLINE( 131)		this->game->__SetField(HX_("inCutscene",8f,21,01,56),value,::hx::paccDynamic);
...
bool BaseStage_obj::get_canPause(){
            	HX_STACKFRAME(&_hx_pos_3e78deb4e15a8a4d_134_get_canPause)
HXDLIN( 134)		return ( (bool)(this->game->__Field(HX_("canPause",c6,18,eb,2b),::hx::paccDynamic)) );
            	}
...
bool BaseStage_obj::set_canPause(bool value){
            	HX_STACKFRAME(&_hx_pos_3e78deb4e15a8a4d_136_set_canPause)
HXLINE( 137)		this->game->__SetField(HX_("canPause",c6,18,eb,2b),value,::hx::paccDynamic);
...
HX_DEFINE_DYNAMIC_FUNC1(BaseStage_obj,set_canPause,return )
 ...
 ::Dynamic BaseStage_obj::get_members(){
            	HX_STACKFRAME(&_hx_pos_3e78deb4e15a8a4d_140_get_members)
HXDLIN( 140)		return  ::Dynamic(this->game->__Field(HX_("members",d9,2c,70,1a),::hx::paccDynamic));
            	}


HX_DEFINE_DYNAMIC_FUNC0(BaseStage_obj,get_members,return )

 ::Dynamic BaseStage_obj::set_game( ::backend::MusicBeatState value){
            	HX_STACKFRAME(&_hx_pos_3e78deb4e15a8a4d_142_set_game)
HXLINE( 143)		this->onPlayState = ::Std_obj::isOfType(value,::hx::ClassOf< ::states::PlayState >());
HXLINE( 144)		this->game = value;
...
HX_DEFINE_DYNAMIC_FUNC1(BaseStage_obj,set_game,return )
 ...
 ::objects::Character BaseStage_obj::get_boyfriend(){
            	HX_STACKFRAME(&_hx_pos_3e78deb4e15a8a4d_148_get_boyfriend)
HXDLIN( 148)		return ( ( ::objects::Character)(this->game->__Field(HX_("boyfriend",6a,29,b8,e6),::hx::paccDynamic)) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(BaseStage_obj,get_boyfriend,return )
 ...
 ::objects::Character BaseStage_obj::get_dad(){
            	HX_STACKFRAME(&_hx_pos_3e78deb4e15a8a4d_149_get_dad)
HXDLIN( 149)		return ( ( ::objects::Character)(this->game->__Field(HX_("dad",47,36,4c,00),::hx::paccDynamic)) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(BaseStage_obj,get_dad,return )
 ...
 ::objects::Character BaseStage_obj::get_gf(){
            	HX_STACKFRAME(&_hx_pos_3e78deb4e15a8a4d_150_get_gf)
HXDLIN( 150)		return ( ( ::objects::Character)(this->game->__Field(HX_("gf",1f,5a,00,00),::hx::paccDynamic)) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(BaseStage_obj,get_gf,return )
 ...
 ::flixel::group::FlxTypedSpriteGroup BaseStage_obj::get_boyfriendGroup(){
            	HX_STACKFRAME(&_hx_pos_3e78deb4e15a8a4d_152_get_boyfriendGroup)
HXDLIN( 152)		return ( ( ::flixel::group::FlxTypedSpriteGroup)(this->game->__Field(HX_("boyfriendGroup",75,99,09,ef),::hx::paccDynamic)) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(BaseStage_obj,get_boyfriendGroup,return )
 ...
 ::flixel::group::FlxTypedSpriteGroup BaseStage_obj::get_dadGroup(){
            	HX_STACKFRAME(&_hx_pos_3e78deb4e15a8a4d_153_get_dadGroup)
HXDLIN( 153)		return ( ( ::flixel::group::FlxTypedSpriteGroup)(this->game->__Field(HX_("dadGroup",78,cb,28,42),::hx::paccDynamic)) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(BaseStage_obj,get_dadGroup,return )
 ...
 ::flixel::group::FlxTypedSpriteGroup BaseStage_obj::get_gfGroup(){
            	HX_STACKFRAME(&_hx_pos_3e78deb4e15a8a4d_154_get_gfGroup)
HXDLIN( 154)		return ( ( ::flixel::group::FlxTypedSpriteGroup)(this->game->__Field(HX_("gfGroup",a0,b8,ab,b0),::hx::paccDynamic)) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(BaseStage_obj,get_gfGroup,return )
 ...
 ::flixel::FlxCamera BaseStage_obj::get_camGame(){
            	HX_STACKFRAME(&_hx_pos_3e78deb4e15a8a4d_156_get_camGame)
HXDLIN( 156)		return ( ( ::flixel::FlxCamera)(this->game->__Field(HX_("camGame",a1,47,50,cf),::hx::paccDynamic)) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(BaseStage_obj,get_camGame,return )
 ...
 ::flixel::FlxCamera BaseStage_obj::get_camHUD(){
            	HX_STACKFRAME(&_hx_pos_3e78deb4e15a8a4d_157_get_camHUD)
HXDLIN( 157)		return ( ( ::flixel::FlxCamera)(this->game->__Field(HX_("camHUD",e8,2b,76,b7),::hx::paccDynamic)) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(BaseStage_obj,get_camHUD,return )
 ...
 ::flixel::FlxCamera BaseStage_obj::get_camOther(){
            	HX_STACKFRAME(&_hx_pos_3e78deb4e15a8a4d_158_get_camOther)
HXDLIN( 158)		return ( ( ::flixel::FlxCamera)(this->game->__Field(HX_("camOther",41,4c,ae,3e),::hx::paccDynamic)) );
            	}
...
Float BaseStage_obj::get_defaultCamZoom(){
            	HX_STACKFRAME(&_hx_pos_3e78deb4e15a8a4d_160_get_defaultCamZoom)
HXDLIN( 160)		return ( (Float)(this->game->__Field(HX_("defaultCamZoom",01,50,2a,0b),::hx::paccDynamic)) );
            	}
...
Float BaseStage_obj::set_defaultCamZoom(Float value){
            	HX_STACKFRAME(&_hx_pos_3e78deb4e15a8a4d_162_set_defaultCamZoom)
HXLINE( 163)		this->game->__SetField(HX_("defaultCamZoom",01,50,2a,0b),value,::hx::paccDynamic);
HXLINE( 164)		return ( (Float)(this->game->__Field(HX_("defaultCamZoom",01,50,2a,0b),::hx::paccDynamic)) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(BaseStage_obj,set_defaultCamZoom,return )
 ...
 ::flixel::FlxObject BaseStage_obj::get_camFollow(){
            	HX_STACKFRAME(&_hx_pos_3e78deb4e15a8a4d_166_get_camFollow)
HXDLIN( 166)		return ( ( ::flixel::FlxObject)(this->game->__Field(HX_("camFollow",e0,6e,47,22),::hx::paccDynamic)) );
            	}
