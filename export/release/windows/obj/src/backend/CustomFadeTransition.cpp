...
HXLINE(  64)			if (::hx::IsNotNull( ::backend::CustomFadeTransition_obj::finishCallback )) {
HXLINE(  64)				::backend::CustomFadeTransition_obj::finishCallback();
            			}
HXLINE(  65)			::backend::CustomFadeTransition_obj::finishCallback = null();
            		}
            	}
