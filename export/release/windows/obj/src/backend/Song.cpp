...
HX_DEFINE_STACK_FRAME(_hx_pos_db09ff2b98ac40f1_33_new,"backend.Song","new",0x743f8f01,"backend.Song.new","backend/Song.hx",33,0x16217dae)
HX_LOCAL_STACK_FRAME(_hx_pos_db09ff2b98ac40f1_54_onLoadJson,"backend.Song","onLoadJson",0xada0af2c,"backend.Song.onLoadJson","backend/Song.hx",54,0x16217dae)
HX_LOCAL_STACK_FRAME(_hx_pos_db09ff2b98ac40f1_94_loadFromJson,"backend.Song","loadFromJson",0xc81ee237,"backend.Song.loadFromJson","backend/Song.hx",94,0x16217dae)
HX_LOCAL_STACK_FRAME(_hx_pos_db09ff2b98ac40f1_147_parseJSONshit,"backend.Song","parseJSONshit",0x02743afc,"backend.Song.parseJSONshit","backend/Song.hx",147,0x16217dae)
namespace backend{

void Song_obj::__construct(::String song,::Array< ::Dynamic> notes,Float bpm){
            	HX_STACKFRAME(&_hx_pos_db09ff2b98ac40f1_33_new)
...
HXLINE(  46)		this->disableNoteRGB = false;
...
void Song_obj::onLoadJson( ::Dynamic songJson){
            	HX_STACKFRAME(&_hx_pos_db09ff2b98ac40f1_54_onLoadJson)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Song_obj,onLoadJson,(void))
 ...
 ::Dynamic Song_obj::loadFromJson(::String jsonInput,::String folder){
            	HX_GC_STACKFRAME(&_hx_pos_db09ff2b98ac40f1_94_loadFromJson)
...
HXLINE( 100)		::String moddyFile = ::backend::Paths_obj::modFolders(((HX_("data/",c5,0e,88,d4) + ((formattedFolder + HX_("/",2f,00,00,00)) + formattedSong)) + HX_(".json",56,f1,d6,c2)));
...
HXDLIN( 107)			::String path2 = ::backend::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + ((formattedFolder + HX_("/",2f,00,00,00)) + formattedSong)) + HX_(".json",56,f1,d6,c2)),HX_("TEXT",ad,94,ba,37),library,null());
HXLINE( 110)			if (::sys::FileSystem_obj::exists(path2)) {
HXLINE( 111)				rawJson = ::StringTools_obj::trim(::sys::io::File_obj::getContent(path2));
            			}
            			else {
HXLINE( 114)				::String library1 = null();
HXDLIN( 114)				rawJson = ::StringTools_obj::trim(::lime::utils::Assets_obj::getText(::backend::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + ((formattedFolder + HX_("/",2f,00,00,00)) + formattedSong)) + HX_(".json",56,f1,d6,c2)),HX_("TEXT",ad,94,ba,37),library1,null())));
            			}
            		}
HXLINE( 117)		while(!(::StringTools_obj::endsWith(rawJson,HX_("}",7d,00,00,00)))){
HXLINE( 119)			rawJson = rawJson.substr(0,(rawJson.length - 1));
            		}
HXLINE( 139)		 ::Dynamic songJson = ::backend::Song_obj::parseJSONshit(rawJson);
HXLINE( 140)		if ((jsonInput != HX_("events",19,4f,6a,96))) {
HXLINE( 140)			::backend::StageData_obj::loadDirectory(songJson);
            		}
HXLINE( 141)		::backend::Song_obj::onLoadJson(songJson);
HXLINE( 142)		return songJson;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Song_obj,loadFromJson,return )
 ...
 ::Dynamic Song_obj::parseJSONshit(::String rawJson){
            	HX_GC_STACKFRAME(&_hx_pos_db09ff2b98ac40f1_147_parseJSONshit)
HXDLIN( 147)		return  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,rawJson)->doParse()->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic);
            	}
