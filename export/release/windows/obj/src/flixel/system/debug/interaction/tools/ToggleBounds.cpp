...
HX_DEFINE_STACK_FRAME(_hx_pos_1074f3f7efdcd5ae_26_new,"flixel.system.debug.interaction.tools.ToggleBounds","new",0x2a585212,"flixel.system.debug.interaction.tools.ToggleBounds.new","flixel/system/debug/interaction/tools/ToggleBounds.hx",26,0x3ea2f7db)
HX_LOCAL_STACK_FRAME(_hx_pos_1074f3f7efdcd5ae_29_init,"flixel.system.debug.interaction.tools.ToggleBounds","init",0xdfa8351e,"flixel.system.debug.interaction.tools.ToggleBounds.init","flixel/system/debug/interaction/tools/ToggleBounds.hx",29,0x3ea2f7db)
HX_LOCAL_STACK_FRAME(_hx_pos_1074f3f7efdcd5ae_43_update,"flixel.system.debug.interaction.tools.ToggleBounds","update",0x31af9f97,"flixel.system.debug.interaction.tools.ToggleBounds.update","flixel/system/debug/interaction/tools/ToggleBounds.hx",43,0x3ea2f7db)
HX_LOCAL_STACK_FRAME(_hx_pos_1074f3f7efdcd5ae_50_onButtonClicked,"flixel.system.debug.interaction.tools.ToggleBounds","onButtonClicked",0x3f28eae8,"flixel.system.debug.interaction.tools.ToggleBounds.onButtonClicked","flixel/system/debug/interaction/tools/ToggleBounds.hx",50,0x3ea2f7db)
namespace flixel{
...
void ToggleBounds_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_1074f3f7efdcd5ae_26_new)
...
bool ToggleBounds_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::flixel::_hx_system::debug::interaction::tools::Tool ToggleBounds_obj::init( ::flixel::_hx_system::debug::interaction::Interaction brain){
            	HX_STACKFRAME(&_hx_pos_1074f3f7efdcd5ae_29_init)
HXLINE(  30)		this->super::init(brain);
HXLINE(  32)		this->_name = HX_("Toggle Debug Draw",1d,76,e8,10);
HXLINE(  33)		this->setButton(::hx::ClassOf< ::flixel::_hx_system::debug::interaction::tools::_ToggleBounds::GraphicToggleBoundsTool >());
HXLINE(  34)		this->button->toggleMode = false;
HXLINE(  39)		return ::hx::ObjectPtr<OBJ_>(this);
            	}


void ToggleBounds_obj::update(){
            	HX_STACKFRAME(&_hx_pos_1074f3f7efdcd5ae_43_update)
HXLINE(  44)		bool _hx_tmp;
HXDLIN(  44)		if (::flixel::FlxG_obj::debugger->drawDebug) {
HXLINE(  44)			_hx_tmp = (this->_brain->selectedItems->countLiving() > 0);
            		}
            		else {
HXLINE(  44)			_hx_tmp = false;
            		}
HXDLIN(  44)		this->button->enabled = _hx_tmp;
HXLINE(  45)		this->button->mouseEnabled = this->button->enabled;
HXLINE(  46)		Float _hx_tmp1;
HXDLIN(  46)		if (this->button->enabled) {
HXLINE(  46)			_hx_tmp1 = ((Float)0.3);
            		}
            		else {
HXLINE(  46)			_hx_tmp1 = ((Float)0.1);
            		}
HXDLIN(  46)		this->button->set_alpha(_hx_tmp1);
            	}


void ToggleBounds_obj::onButtonClicked(){
            	HX_STACKFRAME(&_hx_pos_1074f3f7efdcd5ae_50_onButtonClicked)
            	}
