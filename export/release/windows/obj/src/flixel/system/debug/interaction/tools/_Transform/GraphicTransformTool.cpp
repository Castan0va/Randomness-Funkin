...
HX_DEFINE_STACK_FRAME(_hx_pos_32c10ea2e49f80ec_19_new,"flixel.system.debug.interaction.tools._Transform.GraphicTransformTool","new",0x20b2a6b8,"flixel.system.debug.interaction.tools._Transform.GraphicTransformTool.new","flixel/system/debug/interaction/tools/Transform.hx",19,0xb006466c)
namespace flixel{
...
void GraphicTransformTool_obj::__construct(int width,int height, ::Dynamic transparent, ::Dynamic fillColor){
            	HX_STACKFRAME(&_hx_pos_32c10ea2e49f80ec_19_new)
