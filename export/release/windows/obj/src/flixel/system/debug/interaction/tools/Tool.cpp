...
HXLINE(  50)		::String tooltipName = this->_name;
HXLINE(  51)		if (::hx::IsNotNull( this->_shortcut )) {
HXLINE(  52)			tooltipName = (tooltipName + ((HX_(" (",08,1c,00,00) + this->_shortcut) + HX_(")",29,00,00,00)));
            		}
HXLINE(  53)		::flixel::_hx_system::debug::Tooltip_obj::add(this->button,tooltipName);
            	}
