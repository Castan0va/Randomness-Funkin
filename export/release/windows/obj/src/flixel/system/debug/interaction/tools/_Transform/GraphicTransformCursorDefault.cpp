...
HX_DEFINE_STACK_FRAME(_hx_pos_672128f70c911a77_22_new,"flixel.system.debug.interaction.tools._Transform.GraphicTransformCursorDefault","new",0x2f427ecf,"flixel.system.debug.interaction.tools._Transform.GraphicTransformCursorDefault.new","flixel/system/debug/interaction/tools/Transform.hx",22,0xb006466c)
namespace flixel{
...
void GraphicTransformCursorDefault_obj::__construct(int width,int height, ::Dynamic transparent, ::Dynamic fillColor){
            	HX_STACKFRAME(&_hx_pos_672128f70c911a77_22_new)
