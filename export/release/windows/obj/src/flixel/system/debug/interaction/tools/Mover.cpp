...
HXLINE(  25)		Float x = brain->flixelPointer->x;
HXDLIN(  25)		Float y = brain->flixelPointer->x;
HXDLIN(  25)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x,y);
HXDLIN(  25)		point->_inPool = false;
HXDLIN(  25)		this->_lastCursorPosition = point;
