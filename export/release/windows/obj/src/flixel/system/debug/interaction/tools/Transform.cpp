...
HXLINE(  68)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(  68)		point->_inPool = false;
HXDLIN(  68)		this->_mouseCursor = point;
...
HXDLIN(  63)		this->_actionScaleDirection = point1;
HXLINE(  60)		 ::flixel::math::FlxBasePoint point2 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(  60)		point2->_inPool = false;
HXDLIN(  60)		this->_actionStartPoint = point2;
HXLINE(  58)		 ::flixel::math::FlxBasePoint point3 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(  58)		point3->_inPool = false;
HXDLIN(  58)		this->_actionTargetStartScale = point3;
...
HXDLIN(  87)			_hx_tmp->push(point);
HXDLIN(  87)			::Array< ::Dynamic> _hx_tmp1 = this->_markers;
HXDLIN(  87)			 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(  87)			point1->_inPool = false;
HXDLIN(  87)			_hx_tmp1->push(point1);
HXDLIN(  87)			::Array< ::Dynamic> _hx_tmp2 = this->_markers;
HXDLIN(  87)			 ::flixel::math::FlxBasePoint point2 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(  87)			point2->_inPool = false;
HXDLIN(  87)			_hx_tmp2->push(point2);
HXDLIN(  87)			::Array< ::Dynamic> _hx_tmp3 = this->_markers;
HXDLIN(  87)			 ::flixel::math::FlxBasePoint point3 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN(  87)			point3->_inPool = false;
HXDLIN(  87)			_hx_tmp3->push(point3);
            		}
