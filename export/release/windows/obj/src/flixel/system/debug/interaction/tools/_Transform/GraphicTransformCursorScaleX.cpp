...
HX_DEFINE_STACK_FRAME(_hx_pos_7cb18ceb27f94e49_28_new,"flixel.system.debug.interaction.tools._Transform.GraphicTransformCursorScaleX","new",0xd67be164,"flixel.system.debug.interaction.tools._Transform.GraphicTransformCursorScaleX.new","flixel/system/debug/interaction/tools/Transform.hx",28,0xb006466c)
namespace flixel{
...
void GraphicTransformCursorScaleX_obj::__construct(int width,int height, ::Dynamic transparent, ::Dynamic fillColor){
            	HX_STACKFRAME(&_hx_pos_7cb18ceb27f94e49_28_new)
