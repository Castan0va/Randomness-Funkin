...
HXLINE(  60)			 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(0,0);
HXDLIN(  60)			point->_inPool = false;
HXDLIN(  60)			this->direction = point;
            		}
HXLINE(  62)		{
