...
HX_LOCAL_STACK_FRAME(_hx_pos_904b05de766b1fa3_344_mouseInRect,"flixel.addons.ui.FlxSlider","mouseInRect",0xc843ba02,"flixel.addons.ui.FlxSlider.mouseInRect","flixel/addons/ui/FlxSlider.hx",344,0x927a0a9d)
HX_LOCAL_STACK_FRAME(_hx_pos_904b05de766b1fa3_353_updateValue,"flixel.addons.ui.FlxSlider","updateValue",0x61ff42fc,"flixel.addons.ui.FlxSlider.updateValue","flixel/addons/ui/FlxSlider.hx",353,0x927a0a9d)
HX_LOCAL_STACK_FRAME(_hx_pos_904b05de766b1fa3_377_setTexts,"flixel.addons.ui.FlxSlider","setTexts",0x49045d50,"flixel.addons.ui.FlxSlider.setTexts","flixel/addons/ui/FlxSlider.hx",377,0x927a0a9d)
HX_LOCAL_STACK_FRAME(_hx_pos_904b05de766b1fa3_427_destroy,"flixel.addons.ui.FlxSlider","destroy",0x763bcd4e,"flixel.addons.ui.FlxSlider.destroy","flixel/addons/ui/FlxSlider.hx",427,0x927a0a9d)
HX_LOCAL_STACK_FRAME(_hx_pos_904b05de766b1fa3_441_get_expectedPos,"flixel.addons.ui.FlxSlider","get_expectedPos",0x1d9d0de7,"flixel.addons.ui.FlxSlider.get_expectedPos","flixel/addons/ui/FlxSlider.hx",441,0x927a0a9d)
HX_LOCAL_STACK_FRAME(_hx_pos_904b05de766b1fa3_458_get_relativePos,"flixel.addons.ui.FlxSlider","get_relativePos",0x5a4b2c13,"flixel.addons.ui.FlxSlider.get_relativePos","flixel/addons/ui/FlxSlider.hx",458,0x927a0a9d)
HX_LOCAL_STACK_FRAME(_hx_pos_904b05de766b1fa3_471_set_varString,"flixel.addons.ui.FlxSlider","set_varString",0xced9704f,"flixel.addons.ui.FlxSlider.set_varString","flixel/addons/ui/FlxSlider.hx",471,0x927a0a9d)
HX_LOCAL_STACK_FRAME(_hx_pos_904b05de766b1fa3_487_set_x,"flixel.addons.ui.FlxSlider","set_x",0x5956beaf,"flixel.addons.ui.FlxSlider.set_x","flixel/addons/ui/FlxSlider.hx",487,0x927a0a9d)
HX_LOCAL_STACK_FRAME(_hx_pos_904b05de766b1fa3_494_set_y,"flixel.addons.ui.FlxSlider","set_y",0x5956beb0,"flixel.addons.ui.FlxSlider.set_y","flixel/addons/ui/FlxSlider.hx",494,0x927a0a9d)
HX_LOCAL_STACK_FRAME(_hx_pos_904b05de766b1fa3_502_updateBounds,"flixel.addons.ui.FlxSlider","updateBounds",0x73c1dc8a,"flixel.addons.ui.FlxSlider.updateBounds","flixel/addons/ui/FlxSlider.hx",502,0x927a0a9d)
namespace flixel{
namespace addons{
namespace ui{
...
HXLINE( 274)		if (this->mouseInRect(this->_bounds)) {
...
HXLINE( 292)				 ::flixel::FlxSprite _hx_tmp2 = this->handle;
HXDLIN( 292)				 ::flixel::input::mouse::FlxMouse this1 = ::flixel::FlxG_obj::mouse;
HXDLIN( 292)				_hx_tmp2->set_x(this1->getPositionInCameraView(this->get_camera(),null())->x);
HXLINE( 293)				this->updateValue();
HXLINE( 296)				bool _hx_tmp3;
HXDLIN( 296)				if (::hx::IsNotNull( this->clickSound )) {
HXLINE( 296)					_hx_tmp3 = !(this->_justClicked);
            				}
            				else {
...
HXLINE( 303)				_hx_tmp4 = (_this1->current == 2);
            			}
            			else {
...
HXLINE( 319)			_hx_tmp6 = (_this2->current == 2);
            		}
            		else {
HXLINE( 319)			_hx_tmp6 = true;
            		}
HXDLIN( 319)		if (_hx_tmp6) {
HXLINE( 319)			_hx_tmp5 = this->mouseInRect(this->_bounds);
            		}
            		else {
...
HXLINE( 325)			_hx_tmp7 = ::hx::IsNotNull( ::Reflect_obj::getProperty(this->_object,this->varString) );
            		}
            		else {
...
HXLINE( 331)		Float _hx_tmp8 = this->handle->x;
HXDLIN( 331)		if ((_hx_tmp8 != this->get_expectedPos())) {
HXLINE( 333)			 ::flixel::FlxSprite _hx_tmp9 = this->handle;
HXDLIN( 333)			_hx_tmp9->set_x(this->get_expectedPos());
            		}
HXLINE( 337)		 ::flixel::text::FlxText _hx_tmp10 = this->valueLabel;
HXDLIN( 337)		_hx_tmp10->set_text(::Std_obj::string(::flixel::math::FlxMath_obj::roundDecimal(this->value,this->decimals)));
HXLINE( 339)		this->super::update(elapsed);
            	}


bool FlxSlider_obj::mouseInRect( ::flixel::math::FlxRect rect){
            	HX_STACKFRAME(&_hx_pos_904b05de766b1fa3_344_mouseInRect)
HXDLIN( 344)		 ::flixel::input::mouse::FlxMouse this1 = ::flixel::FlxG_obj::mouse;
HXDLIN( 344)		Float _hx_tmp = this1->getPositionInCameraView(this->get_camera(),null())->x;
HXDLIN( 344)		 ::flixel::input::mouse::FlxMouse this2 = ::flixel::FlxG_obj::mouse;
HXDLIN( 344)		if (::flixel::math::FlxMath_obj::pointInFlxRect(_hx_tmp,this2->getPositionInCameraView(this->get_camera(),null())->y,rect)) {
HXDLIN( 344)			return true;
            		}
            		else {
...
HX_DEFINE_DYNAMIC_FUNC1(FlxSlider_obj,mouseInRect,return )

void FlxSlider_obj::updateValue(){
            	HX_STACKFRAME(&_hx_pos_904b05de766b1fa3_353_updateValue)
HXDLIN( 353)		Float _hx_tmp = this->_lastPos;
HXDLIN( 353)		if ((_hx_tmp != this->get_relativePos())) {
HXLINE( 355)			bool _hx_tmp1;
HXDLIN( 355)			if (this->setVariable) {
HXLINE( 355)				_hx_tmp1 = ::hx::IsNotNull( this->varString );
            			}
            			else {
HXLINE( 355)				_hx_tmp1 = false;
            			}
HXDLIN( 355)			if (_hx_tmp1) {
HXLINE( 357)				 ::Dynamic _hx_tmp2 = this->_object;
HXDLIN( 357)				::String _hx_tmp3 = this->varString;
HXDLIN( 357)				Float _hx_tmp4 = this->get_relativePos();
HXDLIN( 357)				::Reflect_obj::setProperty(_hx_tmp2,_hx_tmp3,((_hx_tmp4 * (this->maxValue - this->minValue)) + this->minValue));
            			}
HXLINE( 360)			this->_lastPos = this->get_relativePos();
HXLINE( 362)			if (::hx::IsNotNull( this->callback )) {
HXLINE( 363)				 ::Dynamic _hx_tmp5 = this->callback;
HXDLIN( 363)				_hx_tmp5(this->get_relativePos());
            			}
            		}
            	}
...
void FlxSlider_obj::setTexts(::String Name,::hx::Null< bool >  __o_Value,::String Min,::String Max,::hx::Null< int >  __o_Size){
            	...
            	HX_STACKFRAME(&_hx_pos_904b05de766b1fa3_377_setTexts)
HXLINE( 378)		if (::hx::IsNull( Name )) {
HXLINE( 380)			this->nameLabel->set_visible(false);
            		}
            		else {
HXLINE( 384)			this->nameLabel->set_text(Name);
HXLINE( 385)			this->nameLabel->set_visible(true);
            		}
HXLINE( 388)		if (::hx::IsNull( Min )) {
HXLINE( 390)			this->minLabel->set_visible(false);
            		}
            		else {
HXLINE( 394)			this->minLabel->set_text(Min);
HXLINE( 395)			this->minLabel->set_visible(true);
            		}
HXLINE( 398)		if (::hx::IsNull( Max )) {
HXLINE( 400)			this->maxLabel->set_visible(false);
            		}
            		else {
HXLINE( 404)			this->maxLabel->set_text(Max);
HXLINE( 405)			this->maxLabel->set_visible(true);
            		}
HXLINE( 408)		if (!(Value)) {
HXLINE( 410)			this->valueLabel->set_visible(false);
            		}
            		else {
HXLINE( 414)			this->valueLabel->set_visible(true);
            		}
HXLINE( 417)		this->nameLabel->set_size(Size);
HXLINE( 418)		this->valueLabel->set_size(Size);
HXLINE( 419)		this->minLabel->set_size(Size);
HXLINE( 420)		this->maxLabel->set_size(Size);
            	}
...
void FlxSlider_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_904b05de766b1fa3_427_destroy)
HXLINE( 428)		this->body = ( ( ::flixel::FlxSprite)(::flixel::util::FlxDestroyUtil_obj::destroy(this->body)) );
HXLINE( 429)		this->handle = ( ( ::flixel::FlxSprite)(::flixel::util::FlxDestroyUtil_obj::destroy(this->handle)) );
HXLINE( 430)		this->minLabel = ( ( ::flixel::text::FlxText)(::flixel::util::FlxDestroyUtil_obj::destroy(this->minLabel)) );
HXLINE( 431)		this->maxLabel = ( ( ::flixel::text::FlxText)(::flixel::util::FlxDestroyUtil_obj::destroy(this->maxLabel)) );
HXLINE( 432)		this->nameLabel = ( ( ::flixel::text::FlxText)(::flixel::util::FlxDestroyUtil_obj::destroy(this->nameLabel)) );
HXLINE( 433)		this->valueLabel = ( ( ::flixel::text::FlxText)(::flixel::util::FlxDestroyUtil_obj::destroy(this->valueLabel)) );
HXLINE( 435)		this->_bounds = ( ( ::flixel::math::FlxRect)(::flixel::util::FlxDestroyUtil_obj::put(this->_bounds)) );
HXLINE( 437)		this->super::destroy();
            	}


Float FlxSlider_obj::get_expectedPos(){
            	HX_STACKFRAME(&_hx_pos_904b05de766b1fa3_441_get_expectedPos)
HXLINE( 442)		Float pos = (this->x + this->offset->x);
HXDLIN( 442)		int pos1 = this->_width;
HXDLIN( 442)		Float pos2 = (( (Float)(pos1) ) - this->handle->get_width());
HXDLIN( 442)		Float pos3 = (pos + (pos2 * ((this->value - this->minValue) / (this->maxValue - this->minValue))));
HXLINE( 445)		if ((pos3 > ((this->x + this->_width) + this->offset->x))) {
HXLINE( 447)			pos3 = ((this->x + this->_width) + this->offset->x);
            		}
            		else {
HXLINE( 449)			if ((pos3 < (this->x + this->offset->x))) {
HXLINE( 451)				pos3 = (this->x + this->offset->x);
            			}
            		}
HXLINE( 454)		return pos3;
            	}
...
Float FlxSlider_obj::get_relativePos(){
            	HX_STACKFRAME(&_hx_pos_904b05de766b1fa3_458_get_relativePos)
HXLINE( 459)		Float pos = ((this->handle->x - this->x) - this->offset->x);
HXDLIN( 459)		int pos1 = this->_width;
HXDLIN( 459)		Float pos2 = (pos / (( (Float)(pos1) ) - this->handle->get_width()));
HXLINE( 462)		if ((pos2 > 1)) {
HXLINE( 464)			pos2 = ( (Float)(1) );
            		}
HXLINE( 467)		return pos2;
            	}
...
::String FlxSlider_obj::set_varString(::String Value){
            	HX_STACKFRAME(&_hx_pos_904b05de766b1fa3_471_set_varString)
HXLINE( 472)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 474)			::Reflect_obj::getProperty(this->_object,Value);
HXLINE( 475)			this->varString = Value;
            		} catch( ::Dynamic _hx_e) {
...
HXLINE( 479)				{
HXLINE( 479)					 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN( 479)					 ::Dynamic data = ((((HX_("Could not create FlxSlider - '",0f,42,71,c5) + Value) + HX_("' is not a valid field of '",71,fa,35,d8)) + ::Std_obj::string(this->_object)) + HX_("'",27,00,00,00));
HXDLIN( 479)					_this->advanced(data,::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            				}
HXLINE( 480)				this->varString = null();
            			}
            			else {
...
Float FlxSlider_obj::set_x(Float value){
            	HX_STACKFRAME(&_hx_pos_904b05de766b1fa3_487_set_x)
HXLINE( 488)		this->super::set_x(value);
HXLINE( 489)		if (::hx::IsNotNull( this->_bounds )) {
HXLINE( 489)			 ::flixel::math::FlxRect _this = this->_bounds;
HXDLIN( 489)			_this->x = (this->x + this->offset->x);
HXDLIN( 489)			_this->y = (this->y + this->offset->y);
HXDLIN( 489)			_this->width = ( (Float)(this->_width) );
HXDLIN( 489)			_this->height = ( (Float)(this->_height) );
            		}
HXLINE( 490)		return (this->x = value);
            	}


Float FlxSlider_obj::set_y(Float value){
            	HX_STACKFRAME(&_hx_pos_904b05de766b1fa3_494_set_y)
HXLINE( 495)		this->super::set_y(value);
HXLINE( 496)		if (::hx::IsNotNull( this->_bounds )) {
HXLINE( 496)			 ::flixel::math::FlxRect _this = this->_bounds;
HXDLIN( 496)			_this->x = (this->x + this->offset->x);
HXDLIN( 496)			_this->y = (this->y + this->offset->y);
HXDLIN( 496)			_this->width = ( (Float)(this->_width) );
HXDLIN( 496)			_this->height = ( (Float)(this->_height) );
            		}
...
void FlxSlider_obj::updateBounds(){
            	HX_STACKFRAME(&_hx_pos_904b05de766b1fa3_502_updateBounds)
HXDLIN( 502)		if (::hx::IsNotNull( this->_bounds )) {
HXLINE( 503)			 ::flixel::math::FlxRect _this = this->_bounds;
HXDLIN( 503)			_this->x = (this->x + this->offset->x);
HXDLIN( 503)			_this->y = (this->y + this->offset->y);
HXDLIN( 503)			_this->width = ( (Float)(this->_width) );
HXDLIN( 503)			_this->height = ( (Float)(this->_height) );
            		}
            	}
...
::hx::Val FlxSlider_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 11:
		...
		if (HX_FIELD_EQ(inName,"mouseInRect") ) { return ::hx::Val( mouseInRect_dyn() ); }
