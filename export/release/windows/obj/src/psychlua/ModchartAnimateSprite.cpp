...
void ModchartAnimateSprite_obj::__construct( ::Dynamic __o_x, ::Dynamic __o_y,::String path, ::Dynamic settings){
            		 ::Dynamic x = __o_x;
...
HXLINE(   9)		super::__construct(x,y,path,settings);
...
bool ModchartAnimateSprite_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x6eca17ad) {
		if (inClassId<=(int)0x2c01639b) {
			...
			return inClassId==(int)0x6eca17ad;
		}
	} else {
...
::hx::ObjectPtr< ModchartAnimateSprite_obj > ModchartAnimateSprite_obj::__new( ::Dynamic __o_x, ::Dynamic __o_y,::String path, ::Dynamic settings) {
	::hx::ObjectPtr< ModchartAnimateSprite_obj > __this = new ModchartAnimateSprite_obj();
	__this->__construct(__o_x,__o_y,path,settings);
	return __this;
}

::hx::ObjectPtr< ModchartAnimateSprite_obj > ModchartAnimateSprite_obj::__alloc(::hx::Ctx *_hx_ctx, ::Dynamic __o_x, ::Dynamic __o_y,::String path, ::Dynamic settings) {
