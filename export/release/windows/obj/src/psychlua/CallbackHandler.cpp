...
HXDLIN(  53)				 ::Dynamic e = _g4;
HXLINE(  55)				if (::llua::Lua_helper_obj::sendErrorsToLua) {
HXLINE(  55)					::String _hx_tmp3;
HXDLIN(  55)					if (::hx::IsNotNull( e->__Field(HX_("message",c7,35,11,9a),::hx::paccDynamic) )) {
HXLINE(  55)						_hx_tmp3 = ( (::String)(e->__Field(HX_("message",c7,35,11,9a),::hx::paccDynamic)) );
            					}
            					else {
HXLINE(  55)						_hx_tmp3 = ( (::String)(e) );
            					}
HXDLIN(  55)					linc::lual::error(l,(HX_("CALLBACK ERROR! ",2c,95,4f,d2) + _hx_tmp3));
HXDLIN(  55)					return 0;
            				}
HXLINE(  56)				::haxe::Log_obj::trace(e,::hx::SourceInfo(HX_("source/psychlua/CallbackHandler.hx",b7,9b,b2,87),56,HX_("psychlua.CallbackHandler",54,cd,4c,a6),HX_("call",9e,18,ba,41)));
