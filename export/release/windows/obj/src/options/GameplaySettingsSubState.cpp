...
HX_LOCAL_STACK_FRAME(_hx_pos_37066bb048b40dd4_120_onChangeHitsoundVolume,"options.GameplaySettingsSubState","onChangeHitsoundVolume",0x34624629,"options.GameplaySettingsSubState.onChangeHitsoundVolume","options/GameplaySettingsSubState.hx",120,0x85e60df3)
HX_LOCAL_STACK_FRAME(_hx_pos_37066bb048b40dd4_123_onChangeAutoPause,"options.GameplaySettingsSubState","onChangeAutoPause",0x357b6c54,"options.GameplaySettingsSubState.onChangeAutoPause","options/GameplaySettingsSubState.hx",123,0x85e60df3)
namespace options{
...
HXLINE(  48)		 ::options::Option option6 =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Hitsound Volume",de,af,92,68),HX_("Funny notes does \"Tick!\" when you hit them.",70,27,87,90),HX_("hitsoundVolume",96,34,9b,8f),HX_("percent",c5,aa,da,78),null());
...
HXLINE( 110)		 ::options::Option option12 =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Sustains as One Note",8a,3b,c2,fe),HX_("If checked, Hold Notes can't be pressed if you miss,\nand count as a single Hit/Miss.\nUncheck this if you prefer the old Input System.",4b,cf,1d,20),HX_("guitarHeroSustains",74,ae,d8,47),HX_("bool",2a,84,1b,41),null());
HXLINE( 114)		this->addOption(option12);
...
void GameplaySettingsSubState_obj::onChangeHitsoundVolume(){
            	HX_STACKFRAME(&_hx_pos_37066bb048b40dd4_120_onChangeHitsoundVolume)
HXDLIN( 120)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 120)		 ::openfl::media::Sound _hx_tmp1 = ::backend::Paths_obj::sound(HX_("hitsound",9c,79,fe,2c),null());
HXDLIN( 120)		_hx_tmp->play(_hx_tmp1,::backend::ClientPrefs_obj::data->hitsoundVolume,null(),null(),null(),null());
            	}
...
void GameplaySettingsSubState_obj::onChangeAutoPause(){
            	HX_STACKFRAME(&_hx_pos_37066bb048b40dd4_123_onChangeAutoPause)
HXDLIN( 123)		::flixel::FlxG_obj::autoPause = ::backend::ClientPrefs_obj::data->autoPause;
            	}
