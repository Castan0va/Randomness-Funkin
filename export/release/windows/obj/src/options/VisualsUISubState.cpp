...
HXLINE(  31)			defaultDirectory = HX_("assets/shared/",1e,69,1e,47);
            		}
...
HXLINE(  31)						_hx_tmp = !(foldersToCheck->contains(folder));
            					}
            					else {
...
HXDLIN(  31)			::String key1 = HX_("images/noteSkins/list.txt",42,a1,fc,21);
HXDLIN(  31)			if (::hx::IsNull( key1 )) {
HXLINE(  31)				key1 = HX_("",00,00,00,00);
            			}
HXDLIN(  31)			::String folder1 = (HX_("mods/",9e,2f,58,0c) + key1);
HXDLIN(  31)			bool _hx_tmp1;
HXDLIN(  31)			if (::sys::FileSystem_obj::exists(folder1)) {
HXLINE(  31)				_hx_tmp1 = !(foldersToCheck->contains(folder1));
            			}
            			else {
HXLINE(  31)				_hx_tmp1 = false;
            			}
HXDLIN(  31)			if (_hx_tmp1) {
HXLINE(  31)				::String key2 = HX_("images/noteSkins/list.txt",42,a1,fc,21);
HXDLIN(  31)				if (::hx::IsNull( key2 )) {
HXLINE(  31)					key2 = HX_("",00,00,00,00);
            				}
HXDLIN(  31)				foldersToCheck->push((HX_("mods/",9e,2f,58,0c) + key2));
            			}
HXDLIN(  31)			bool _hx_tmp2;
HXDLIN(  31)			if (::hx::IsNotNull( ::backend::Mods_obj::currentModDirectory )) {
HXLINE(  31)				_hx_tmp2 = (::backend::Mods_obj::currentModDirectory.length > 0);
            			}
            			else {
HXLINE(  31)				_hx_tmp2 = false;
            			}
HXDLIN(  31)			if (_hx_tmp2) {
HXLINE(  31)				::String key3 = ((::backend::Mods_obj::currentModDirectory + HX_("/",2f,00,00,00)) + HX_("images/noteSkins/list.txt",42,a1,fc,21));
HXDLIN(  31)				if (::hx::IsNull( key3 )) {
HXLINE(  31)					key3 = HX_("",00,00,00,00);
            				}
HXDLIN(  31)				::String folder2 = (HX_("mods/",9e,2f,58,0c) + key3);
HXDLIN(  31)				bool _hx_tmp3;
HXDLIN(  31)				if (::sys::FileSystem_obj::exists(folder2)) {
HXLINE(  31)					_hx_tmp3 = !(foldersToCheck->contains(folder2));
            				}
            				else {
HXLINE(  31)					_hx_tmp3 = false;
            				}
HXDLIN(  31)				if (_hx_tmp3) {
HXLINE(  31)					foldersToCheck->push(folder2);
            				}
            			}
            		}
...
HXDLIN(  31)					{
HXLINE(  31)						int _g5 = 0;
HXDLIN(  31)						int _g6 = daList1->length;
HXDLIN(  31)						while((_g5 < _g6)){
HXLINE(  31)							_g5 = (_g5 + 1);
HXDLIN(  31)							int i1 = (_g5 - 1);
HXDLIN(  31)							daList1[i1] = ::StringTools_obj::trim(daList1->__get(i1));
            						}
            					}
...
HXDLIN(  31)				{
HXLINE(  31)					int _g7 = 0;
HXDLIN(  31)					while((_g7 < list->length)){
HXLINE(  31)						::String value = list->__get(_g7);
HXDLIN(  31)						_g7 = (_g7 + 1);
HXDLIN(  31)						bool _hx_tmp4;
HXDLIN(  31)						bool _hx_tmp5;
HXDLIN(  31)						if (!(allowDuplicates)) {
HXLINE(  31)							_hx_tmp5 = !(mergedList->contains(value));
            						}
            						else {
HXLINE(  31)							_hx_tmp5 = true;
            						}
HXDLIN(  31)						if (_hx_tmp5) {
HXLINE(  31)							_hx_tmp4 = (value.length > 0);
            						}
            						else {
...
HXLINE(  48)			defaultDirectory1 = HX_("assets/shared/",1e,69,1e,47);
            		}
...
HXLINE(  48)			{
HXLINE(  48)				int _g8 = 0;
HXDLIN(  48)				::Array< ::String > _g9 = ::backend::Mods_obj::globalMods;
HXDLIN(  48)				while((_g8 < _g9->length)){
HXLINE(  48)					::String mod1 = _g9->__get(_g8);
HXDLIN(  48)					_g8 = (_g8 + 1);
HXDLIN(  48)					::String key4 = ((mod1 + HX_("/",2f,00,00,00)) + HX_("images/noteSplashes/list.txt",31,67,e4,1c));
HXDLIN(  48)					if (::hx::IsNull( key4 )) {
HXLINE(  48)						key4 = HX_("",00,00,00,00);
            					}
HXDLIN(  48)					::String folder3 = (HX_("mods/",9e,2f,58,0c) + key4);
HXDLIN(  48)					bool _hx_tmp6;
HXDLIN(  48)					if (::sys::FileSystem_obj::exists(folder3)) {
HXLINE(  48)						_hx_tmp6 = !(foldersToCheck1->contains(folder3));
            					}
            					else {
HXLINE(  48)						_hx_tmp6 = false;
            					}
HXDLIN(  48)					if (_hx_tmp6) {
HXLINE(  48)						foldersToCheck1->push(folder3);
            					}
            				}
            			}
HXDLIN(  48)			::String key5 = HX_("images/noteSplashes/list.txt",31,67,e4,1c);
HXDLIN(  48)			if (::hx::IsNull( key5 )) {
HXLINE(  48)				key5 = HX_("",00,00,00,00);
            			}
HXDLIN(  48)			::String folder4 = (HX_("mods/",9e,2f,58,0c) + key5);
HXDLIN(  48)			bool _hx_tmp7;
HXDLIN(  48)			if (::sys::FileSystem_obj::exists(folder4)) {
HXLINE(  48)				_hx_tmp7 = !(foldersToCheck1->contains(folder4));
            			}
            			else {
HXLINE(  48)				_hx_tmp7 = false;
            			}
HXDLIN(  48)			if (_hx_tmp7) {
HXLINE(  48)				::String key6 = HX_("images/noteSplashes/list.txt",31,67,e4,1c);
HXDLIN(  48)				if (::hx::IsNull( key6 )) {
HXLINE(  48)					key6 = HX_("",00,00,00,00);
            				}
HXDLIN(  48)				foldersToCheck1->push((HX_("mods/",9e,2f,58,0c) + key6));
            			}
HXDLIN(  48)			bool _hx_tmp8;
HXDLIN(  48)			if (::hx::IsNotNull( ::backend::Mods_obj::currentModDirectory )) {
HXLINE(  48)				_hx_tmp8 = (::backend::Mods_obj::currentModDirectory.length > 0);
            			}
            			else {
HXLINE(  48)				_hx_tmp8 = false;
            			}
HXDLIN(  48)			if (_hx_tmp8) {
HXLINE(  48)				::String key7 = ((::backend::Mods_obj::currentModDirectory + HX_("/",2f,00,00,00)) + HX_("images/noteSplashes/list.txt",31,67,e4,1c));
HXDLIN(  48)				if (::hx::IsNull( key7 )) {
HXLINE(  48)					key7 = HX_("",00,00,00,00);
            				}
HXDLIN(  48)				::String folder5 = (HX_("mods/",9e,2f,58,0c) + key7);
HXDLIN(  48)				bool _hx_tmp9;
HXDLIN(  48)				if (::sys::FileSystem_obj::exists(folder5)) {
HXLINE(  48)					_hx_tmp9 = !(foldersToCheck1->contains(folder5));
            				}
            				else {
HXLINE(  48)					_hx_tmp9 = false;
            				}
HXDLIN(  48)				if (_hx_tmp9) {
HXLINE(  48)					foldersToCheck1->push(folder5);
            				}
            			}
            		}
...
HXDLIN(  48)		{
HXLINE(  48)			int _g10 = 0;
HXDLIN(  48)			while((_g10 < paths1->length)){
HXLINE(  48)				::String file1 = paths1->__get(_g10);
HXDLIN(  48)				_g10 = (_g10 + 1);
HXDLIN(  48)				::String path1 = file1;
HXDLIN(  48)				::String daList2 = null();
HXDLIN(  48)				::Array< ::String > formatted1 = path1.split(HX_(":",3a,00,00,00));
HXDLIN(  48)				path1 = formatted1->__get((formatted1->length - 1));
HXDLIN(  48)				if (::sys::FileSystem_obj::exists(path1)) {
HXLINE(  48)					daList2 = ::sys::io::File_obj::getContent(path1);
            				}
HXDLIN(  48)				::Array< ::String > list1;
HXDLIN(  48)				if (::hx::IsNotNull( daList2 )) {
HXLINE(  48)					::Array< ::String > daList3 = ::Array_obj< ::String >::__new(0);
HXDLIN(  48)					daList3 = ::StringTools_obj::trim(daList2).split(HX_("\n",0a,00,00,00));
HXDLIN(  48)					{
HXLINE(  48)						int _g11 = 0;
HXDLIN(  48)						int _g12 = daList3->length;
HXDLIN(  48)						while((_g11 < _g12)){
HXLINE(  48)							_g11 = (_g11 + 1);
HXDLIN(  48)							int i2 = (_g11 - 1);
HXDLIN(  48)							daList3[i2] = ::StringTools_obj::trim(daList3->__get(i2));
            						}
            					}
HXDLIN(  48)					list1 = daList3;
            				}
            				else {
HXLINE(  48)					list1 = ::Array_obj< ::String >::__new(0);
            				}
HXDLIN(  48)				{
HXLINE(  48)					int _g13 = 0;
HXDLIN(  48)					while((_g13 < list1->length)){
HXLINE(  48)						::String value1 = list1->__get(_g13);
HXDLIN(  48)						_g13 = (_g13 + 1);
HXDLIN(  48)						bool _hx_tmp10;
HXDLIN(  48)						bool _hx_tmp11;
HXDLIN(  48)						if (!(allowDuplicates1)) {
HXLINE(  48)							_hx_tmp11 = !(mergedList1->contains(value1));
            						}
            						else {
HXLINE(  48)							_hx_tmp11 = true;
            						}
HXDLIN(  48)						if (_hx_tmp11) {
HXLINE(  48)							_hx_tmp10 = (value1.length > 0);
            						}
            						else {
HXLINE(  48)							_hx_tmp10 = false;
            						}
HXDLIN(  48)						if (_hx_tmp10) {
HXLINE(  48)							mergedList1->push(value1);
            						}
            					}
            				}
            			}
...
HXLINE(  55)			 ::options::Option option1 =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Note Splashes:",57,cb,35,75),HX_("Select your prefered Note Splash variation or turn it off.",ae,cb,6a,a5),HX_("splashSkin",84,03,e1,a1),HX_("string",d1,28,30,11),noteSplashes);
HXLINE(  60)			this->addOption(option1);
            		}
HXLINE(  63)		 ::options::Option option2 =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Note Splash Opacity",60,36,3d,35),HX_("How much transparent should the Note Splashes be.",23,18,f8,99),HX_("splashAlpha",77,20,7a,a6),HX_("percent",c5,aa,da,78),null());
HXLINE(  67)		option2->scrollSpeed = ((Float)1.6);
HXLINE(  68)		option2->minValue = ((Float)0.0);
HXLINE(  69)		option2->maxValue = 1;
HXLINE(  70)		option2->changeValue = ((Float)0.1);
HXLINE(  71)		option2->decimals = 1;
HXLINE(  72)		this->addOption(option2);
HXLINE(  74)		 ::options::Option option3 =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Hide HUD",59,3a,04,5d),HX_("If checked, hides most HUD elements.",b8,a1,19,66),HX_("hideHud",15,b9,3c,b7),HX_("bool",2a,84,1b,41),null());
HXLINE(  78)		this->addOption(option3);
HXLINE(  80)		 ::options::Option option4 =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Time Bar:",fa,e7,52,5c),HX_("What should the Time Bar display?",bd,00,f8,02),HX_("timeBarType",a0,5d,bb,01),HX_("string",d1,28,30,11),::Array_obj< ::String >::fromData( _hx_array_data_f33bd928_10,4));
HXLINE(  85)		this->addOption(option4);
HXLINE(  87)		 ::options::Option option5 =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Flashing Lights",0b,e4,0d,04),HX_("Uncheck this if you're sensitive to flashing lights!",9e,ed,11,12),HX_("flashing",32,85,e8,99),HX_("bool",2a,84,1b,41),null());
HXLINE(  91)		this->addOption(option5);
HXLINE(  93)		 ::options::Option option6 =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Camera Zooms",45,a6,9b,43),HX_("If unchecked, the camera won't zoom in on a beat hit.",fd,78,13,6b),HX_("camZooms",71,f3,cd,90),HX_("bool",2a,84,1b,41),null());
HXLINE(  97)		this->addOption(option6);
HXLINE(  99)		 ::options::Option option7 =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Score Text Zoom on Hit",da,24,e2,56),HX_("If unchecked, disables the Score text zooming\neverytime you hit a note.",bc,95,97,3e),HX_("scoreZoom",85,53,bc,e0),HX_("bool",2a,84,1b,41),null());
HXLINE( 103)		this->addOption(option7);
HXLINE( 105)		 ::options::Option option8 =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Health Bar Opacity",da,18,73,d2),HX_("How much transparent should the health bar and icons be.",16,a5,40,f3),HX_("healthBarAlpha",47,c9,a0,80),HX_("percent",c5,aa,da,78),null());
HXLINE( 109)		option8->scrollSpeed = ((Float)1.6);
HXLINE( 110)		option8->minValue = ((Float)0.0);
HXLINE( 111)		option8->maxValue = 1;
HXLINE( 112)		option8->changeValue = ((Float)0.1);
HXLINE( 113)		option8->decimals = 1;
HXLINE( 114)		this->addOption(option8);
HXLINE( 117)		 ::options::Option option9 =  ::options::Option_obj::__alloc( HX_CTX ,HX_("FPS Counter",85,ef,54,c9),HX_("If unchecked, hides FPS Counter.",17,fc,a1,74),HX_("showFPS",ec,0a,9a,7b),HX_("bool",2a,84,1b,41),null());
HXLINE( 121)		this->addOption(option9);
HXLINE( 122)		option9->onChange = this->onChangeFPSCounter_dyn();
HXLINE( 125)		 ::options::Option option10 =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Pause Screen Song:",9b,6e,16,2a),HX_("What song do you prefer for the Pause Screen?",9a,c8,b3,59),HX_("pauseMusic",cf,6d,d3,e5),HX_("string",d1,28,30,11),::Array_obj< ::String >::fromData( _hx_array_data_f33bd928_11,3));
HXLINE( 130)		this->addOption(option10);
HXLINE( 131)		option10->onChange = this->onChangePauseMusic_dyn();
HXLINE( 142)		 ::options::Option option11 =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Discord Rich Presence",2b,ef,99,77),HX_("Uncheck this to prevent accidental leaks, it will hide the Application from your \"Playing\" box on Discord",0b,e4,6b,c9),HX_("discordRPC",99,18,34,b0),HX_("bool",2a,84,1b,41),null());
HXLINE( 146)		this->addOption(option11);
HXLINE( 149)		 ::options::Option option12 =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Combo Stacking",ec,30,59,b7),HX_("If unchecked, Ratings and Combo won't stack, saving on System Memory and making them easier to read",d6,be,78,3a),HX_("comboStacking",08,45,bb,e0),HX_("bool",2a,84,1b,41),null());
HXLINE( 153)		this->addOption(option12);
...
HXDLIN( 209)			_hx_tmp1->playMusic(file,1,true,null());
            		}
