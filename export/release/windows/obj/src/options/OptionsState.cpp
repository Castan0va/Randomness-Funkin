...
HX_LOCAL_STACK_FRAME(_hx_pos_bddb8806f8971119_70_closeSubState,"options.OptionsState","closeSubState",0xbc3ad39e,"options.OptionsState.closeSubState","options/OptionsState.hx",70,0xaa608eba)
HX_LOCAL_STACK_FRAME(_hx_pos_bddb8806f8971119_78_update,"options.OptionsState","update",0xccb53214,"options.OptionsState.update","options/OptionsState.hx",78,0xaa608eba)
HX_LOCAL_STACK_FRAME(_hx_pos_bddb8806f8971119_101_changeSelection,"options.OptionsState","changeSelection",0xa0e39351,"options.OptionsState.changeSelection","options/OptionsState.hx",101,0xaa608eba)
HX_LOCAL_STACK_FRAME(_hx_pos_bddb8806f8971119_127_destroy,"options.OptionsState","destroy",0xd88d0a8f,"options.OptionsState.destroy","options/OptionsState.hx",127,0xaa608eba)
...
HXLINE(  35)		::openfl::Lib_obj::get_application()->_hx___window->set_title(HX_("Randomness Funkin - Options",62,20,6a,3d));
HXLINE(  37)		::backend::DiscordClient_obj::changePresence(HX_("Options Menu",e1,25,4c,98),null(),null(),null(),null());
...
HXLINE(  42)		bg1->set_color(-1412611);
HXLINE(  43)		bg1->updateHitbox();
HXLINE(  45)		{
...
HXDLIN(  45)				bg1->set_x(((( (Float)(_hx_tmp1) ) - bg1->get_width()) / ( (Float)(2) )));
            			}
...
HXDLIN(  45)				bg1->set_y(((( (Float)(_hx_tmp3) ) - bg1->get_height()) / ( (Float)(2) )));
            			}
            		}
HXLINE(  46)		this->add(bg1);
...
HXLINE(  53)				 ::objects::Alphabet optionText =  ::objects::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),this->options->__get(i),true);
HXLINE(  54)				{
...
HXDLIN(  54)						optionText->set_x(((( (Float)(_hx_tmp5) ) - optionText->get_width()) / ( (Float)(2) )));
            					}
...
HXDLIN(  54)						optionText->set_y(((( (Float)(_hx_tmp7) ) - optionText->get_height()) / ( (Float)(2) )));
            					}
            				}
HXLINE(  55)				optionText->set_y((optionText->y + ((( (Float)(100) ) * (( (Float)(i) ) - (( (Float)(this->options->length) ) / ( (Float)(2) )))) + 50)));
HXLINE(  56)				this->grpOptions->add(optionText).StaticCast<  ::objects::Alphabet >();
            			}
            		}
HXLINE(  59)		this->selectorLeft =  ::objects::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),HX_(">",3e,00,00,00),true);
HXLINE(  60)		this->add(this->selectorLeft);
HXLINE(  61)		this->selectorRight =  ::objects::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),HX_("<",3c,00,00,00),true);
HXLINE(  62)		this->add(this->selectorRight);
HXLINE(  64)		this->changeSelection(null());
HXLINE(  65)		::backend::ClientPrefs_obj::saveSettings();
HXLINE(  67)		this->super::create();
            	}


void OptionsState_obj::closeSubState(){
            	HX_STACKFRAME(&_hx_pos_bddb8806f8971119_70_closeSubState)
HXLINE(  71)		this->super::closeSubState();
HXLINE(  72)		::backend::ClientPrefs_obj::saveSettings();
HXLINE(  74)		::backend::DiscordClient_obj::changePresence(HX_("Options Menu",e1,25,4c,98),null(),null(),null(),null());
            	}


void OptionsState_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_bddb8806f8971119_78_update)
...
HXLINE(  88)		if (this->get_controls()->get_BACK()) {
HXLINE(  89)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN(  89)			_hx_tmp->play(::backend::Paths_obj::sound(HX_("cancelMenu",39,a4,43,b7),null()),null(),null(),null(),null(),null());
HXLINE(  90)			if (::options::OptionsState_obj::onPlayState) {
HXLINE(  92)				::backend::StageData_obj::loadDirectory(::states::PlayState_obj::SONG);
HXLINE(  93)				::backend::MusicBeatState_obj::switchState(::states::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::states::PlayState_obj::__alloc( HX_CTX ,null(),null())) ),false));
HXLINE(  94)				::flixel::FlxG_obj::sound->music->set_volume(( (Float)(0) ));
            			}
            			else {
HXLINE(  96)				::backend::MusicBeatState_obj::switchState( ::states::MainMenuState_obj::__alloc( HX_CTX ,null(),null()));
            			}
            		}
            		else {
HXLINE(  98)			if (this->get_controls()->get_ACCEPT()) {
HXLINE(  98)				this->openSelectedSubstate(this->options->__get(::options::OptionsState_obj::curSelected));
            			}
            		}
            	}
...
void OptionsState_obj::changeSelection(::hx::Null< int >  __o_change){
            	...
            	HX_STACKFRAME(&_hx_pos_bddb8806f8971119_101_changeSelection)
HXLINE( 102)		 ::Dynamic _hx_tmp = ::hx::ClassOf< ::options::OptionsState >();
HXDLIN( 102)		::options::OptionsState_obj::curSelected = (::options::OptionsState_obj::curSelected + change);
HXLINE( 103)		if ((::options::OptionsState_obj::curSelected < 0)) {
HXLINE( 104)			::options::OptionsState_obj::curSelected = (this->options->length - 1);
            		}
HXLINE( 105)		if ((::options::OptionsState_obj::curSelected >= this->options->length)) {
HXLINE( 106)			::options::OptionsState_obj::curSelected = 0;
            		}
HXLINE( 108)		int bullShit = 0;
HXLINE( 110)		{
HXLINE( 110)			int _g = 0;
HXDLIN( 110)			::Array< ::Dynamic> _g1 = this->grpOptions->members;
HXDLIN( 110)			while((_g < _g1->length)){
HXLINE( 110)				 ::objects::Alphabet item = _g1->__get(_g).StaticCast<  ::objects::Alphabet >();
HXDLIN( 110)				_g = (_g + 1);
HXLINE( 111)				item->targetY = (bullShit - ::options::OptionsState_obj::curSelected);
HXLINE( 112)				bullShit = (bullShit + 1);
HXLINE( 114)				item->set_alpha(((Float)0.6));
HXLINE( 115)				if ((item->targetY == 0)) {
HXLINE( 116)					item->set_alpha(( (Float)(1) ));
HXLINE( 117)					this->selectorLeft->set_x((item->x - ( (Float)(63) )));
HXLINE( 118)					this->selectorLeft->set_y(item->y);
HXLINE( 119)					 ::objects::Alphabet _hx_tmp1 = this->selectorRight;
HXDLIN( 119)					Float item1 = item->x;
HXDLIN( 119)					_hx_tmp1->set_x(((item1 + item->get_width()) + 15));
HXLINE( 120)					this->selectorRight->set_y(item->y);
            				}
            			}
            		}
HXLINE( 123)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp2 = ::flixel::FlxG_obj::sound;
HXDLIN( 123)		_hx_tmp2->play(::backend::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),null(),null(),null(),null(),null());
            	}
...
void OptionsState_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_bddb8806f8971119_127_destroy)
HXLINE( 128)		::backend::ClientPrefs_obj::loadPrefs();
