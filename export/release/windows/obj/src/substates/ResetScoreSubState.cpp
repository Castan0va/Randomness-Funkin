...
HXLINE(  65)				_hx_tmp11 = (axes2 == 17);
            			}
            			else {
HXLINE(  65)				_hx_tmp11 = true;
            			}
HXDLIN(  65)			if (_hx_tmp11) {
HXLINE(  65)				int _hx_tmp12 = ::flixel::FlxG_obj::width;
HXDLIN(  65)				_this->set_x(((( (Float)(_hx_tmp12) ) - _this->get_width()) / ( (Float)(2) )));
            			}
HXDLIN(  65)			bool _hx_tmp13;
HXDLIN(  65)			if ((axes2 != 16)) {
HXLINE(  65)				_hx_tmp13 = (axes2 == 17);
            			}
            			else {
HXLINE(  65)				_hx_tmp13 = true;
            			}
HXDLIN(  65)			if (_hx_tmp13) {
HXLINE(  65)				int _hx_tmp14 = ::flixel::FlxG_obj::height;
HXDLIN(  65)				_this->set_y(((( (Float)(_hx_tmp14) ) - _this->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXDLIN(  69)			bool _hx_tmp15;
HXDLIN(  69)			if ((axes3 != 1)) {
HXLINE(  69)				_hx_tmp15 = (axes3 == 17);
            			}
            			else {
HXLINE(  69)				_hx_tmp15 = true;
            			}
HXDLIN(  69)			if (_hx_tmp15) {
HXLINE(  69)				int _hx_tmp16 = ::flixel::FlxG_obj::width;
HXDLIN(  69)				_this1->set_x(((( (Float)(_hx_tmp16) ) - _this1->get_width()) / ( (Float)(2) )));
            			}
...
HXLINE(  69)				int _hx_tmp18 = ::flixel::FlxG_obj::height;
HXDLIN(  69)				_this1->set_y(((( (Float)(_hx_tmp18) ) - _this1->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXLINE(  84)			 ::objects::HealthIcon fh1 = this->icon;
HXDLIN(  84)			fh1->set_alpha((fh1->alpha + (elapsed * ((Float)2.5))));
            		}
...
HXLINE(  87)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp1 = ::flixel::FlxG_obj::sound;
HXDLIN(  87)			_hx_tmp1->play(::backend::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),1,null(),null(),null(),null());
HXLINE(  88)			this->onYes = !(this->onYes);
HXLINE(  89)			this->updateOptions();
            		}
HXLINE(  91)		if (::backend::Controls_obj::instance->get_BACK()) {
HXLINE(  92)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp2 = ::flixel::FlxG_obj::sound;
HXDLIN(  92)			_hx_tmp2->play(::backend::Paths_obj::sound(HX_("cancelMenu",39,a4,43,b7),null()),1,null(),null(),null(),null());
...
HXLINE( 102)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp3 = ::flixel::FlxG_obj::sound;
HXDLIN( 102)				_hx_tmp3->play(::backend::Paths_obj::sound(HX_("cancelMenu",39,a4,43,b7),null()),1,null(),null(),null(),null());
