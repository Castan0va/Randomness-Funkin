...
HX_LOCAL_STACK_FRAME(_hx_pos_b0f2455f0c8a2f5b_672_get_ACF,"flxanimate.data._AnimationData.Filters_Impl_","get_ACF",0x0a948a8e,"flxanimate.data._AnimationData.Filters_Impl_.get_ACF","flxanimate/data/AnimationData.hx",672,0xa9372435)
static const ::String _hx_array_data_67780a41_1[] = {
	HX_("ACF",24,8d,31,00),HX_("AdjustColorFilter",0c,f9,e5,fb),
};
HX_LOCAL_STACK_FRAME(_hx_pos_b0f2455f0c8a2f5b_676_get_GF,"flxanimate.data._AnimationData.Filters_Impl_","get_GF",0x91d75bf5,"flxanimate.data._AnimationData.Filters_Impl_.get_GF","flxanimate/data/AnimationData.hx",676,0xa9372435)
...
bool Filters_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Filters_Impl__obj::get_ACF( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_b0f2455f0c8a2f5b_672_get_ACF)
HXDLIN( 672)		return ::flxanimate::data::AnimationData_obj::setFieldBool(this1,::Array_obj< ::String >::fromData( _hx_array_data_67780a41_1,2),null());
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Filters_Impl__obj,get_ACF,return )
 ...
 ::Dynamic Filters_Impl__obj::get_GF( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_b0f2455f0c8a2f5b_676_get_GF)
HXDLIN( 676)		return ::flxanimate::data::AnimationData_obj::setFieldBool(this1,::Array_obj< ::String >::fromData( _hx_array_data_67780a41_3,1),null());
            	}
