...
HX_LOCAL_STACK_FRAME(_hx_pos_6e9e1b6e8618b267_464_get_ASI,"flxanimate.data._AnimationData.Element_Impl_","get_ASI",0xe03b0542,"flxanimate.data._AnimationData.Element_Impl_.get_ASI","flxanimate/data/AnimationData.hx",464,0xa9372435)
...
bool Element_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Element_Impl__obj::get_ASI( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_6e9e1b6e8618b267_464_get_ASI)
HXDLIN( 464)		return ::flxanimate::data::AnimationData_obj::setFieldBool(this1,::Array_obj< ::String >::fromData( _hx_array_data_63a34e02_1,2),null());
            	}
