...
HX_LOCAL_STACK_FRAME(_hx_pos_f484bcf4ec86cc94_243_get_S,"flxanimate.data._AnimationData.SymbolDictionary_Impl_","get_S",0x2e959204,"flxanimate.data._AnimationData.SymbolDictionary_Impl_.get_S","flxanimate/data/AnimationData.hx",243,0xa9372435)
...
::Array< ::Dynamic> SymbolDictionary_Impl__obj::get_S( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_f484bcf4ec86cc94_243_get_S)
HXDLIN( 243)		return ( (::Array< ::Dynamic>)(::flxanimate::data::AnimationData_obj::setFieldBool(this1,::Array_obj< ::String >::fromData( _hx_array_data_2c2dcdc8_1,2),null())) );
            	}
