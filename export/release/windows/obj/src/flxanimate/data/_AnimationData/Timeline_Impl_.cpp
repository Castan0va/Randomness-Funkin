...
HX_LOCAL_STACK_FRAME(_hx_pos_e976ef2f6d79e063_323_get_L,"flxanimate.data._AnimationData.Timeline_Impl_","get_L",0x5de551f0,"flxanimate.data._AnimationData.Timeline_Impl_.get_L","flxanimate/data/AnimationData.hx",323,0xa9372435)
static const ::String _hx_array_data_3e48457b_1[] = {
	HX_("L",4c,00,00,00),HX_("LAYERS",82,c1,33,0b),
};
HX_LOCAL_STACK_FRAME(_hx_pos_e976ef2f6d79e063_327_set_L,"flxanimate.data._AnimationData.Timeline_Impl_","set_L",0x46b447fc,"flxanimate.data._AnimationData.Timeline_Impl_.set_L","flxanimate/data/AnimationData.hx",327,0xa9372435)
...
::Array< ::Dynamic> Timeline_Impl__obj::get_L( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_e976ef2f6d79e063_323_get_L)
HXDLIN( 323)		return ( (::Array< ::Dynamic>)(::flxanimate::data::AnimationData_obj::setFieldBool(this1,::Array_obj< ::String >::fromData( _hx_array_data_3e48457b_1,2),null())) );
            	}
...
::Array< ::Dynamic> Timeline_Impl__obj::set_L( ::Dynamic this1,::Array< ::Dynamic> value){
            	HX_STACKFRAME(&_hx_pos_e976ef2f6d79e063_327_set_L)
HXDLIN( 327)		return ( (::Array< ::Dynamic>)(::flxanimate::data::AnimationData_obj::setFieldBool(this1,::Array_obj< ::String >::fromData( _hx_array_data_3e48457b_3,2),value)) );
            	}
