...
HX_LOCAL_STACK_FRAME(_hx_pos_98410f9d2044d02f_285_get_SI,"flxanimate.data._AnimationData.StageInstance_Impl_","get_SI",0x5580d034,"flxanimate.data._AnimationData.StageInstance_Impl_.get_SI","flxanimate/data/AnimationData.hx",285,0xa9372435)
...
bool StageInstance_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic StageInstance_Impl__obj::get_SI( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_98410f9d2044d02f_285_get_SI)
HXDLIN( 285)		return ::flxanimate::data::AnimationData_obj::setFieldBool(this1,::Array_obj< ::String >::fromData( _hx_array_data_dcc73779_1,2),null());
            	}
