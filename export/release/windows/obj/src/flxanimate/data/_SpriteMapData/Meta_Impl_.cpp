...
HX_LOCAL_STACK_FRAME(_hx_pos_6f20228922dc61d3_35_get_resolution,"flxanimate.data._SpriteMapData.Meta_Impl_","get_resolution",0x1b520317,"flxanimate.data._SpriteMapData.Meta_Impl_.get_resolution","flxanimate/data/SpriteMapData.hx",35,0xcae02402)
...
::String Meta_Impl__obj::get_resolution( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_6f20228922dc61d3_35_get_resolution)
HXDLIN(  35)		return ( (::String)(::flxanimate::data::AnimationData_obj::setFieldBool(this1,::Array_obj< ::String >::fromData( _hx_array_data_be336c8c_1,2),null())) );
            	}
