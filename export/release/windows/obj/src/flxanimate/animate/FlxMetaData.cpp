...
HX_DEFINE_STACK_FRAME(_hx_pos_c473b54ae7dfc372_536_new,"flxanimate.animate.FlxMetaData","new",0x085bb6a7,"flxanimate.animate.FlxMetaData.new","flxanimate/animate/FlxAnim.hx",536,0x524d8fe9)
HX_LOCAL_STACK_FRAME(_hx_pos_c473b54ae7dfc372_541_destroy,"flxanimate.animate.FlxMetaData","destroy",0x46ec42c1,"flxanimate.animate.FlxMetaData.destroy","flxanimate/animate/FlxAnim.hx",541,0x524d8fe9)
namespace flxanimate{
namespace animate{

void FlxMetaData_obj::__construct(::String name,Float frameRate){
            	HX_STACKFRAME(&_hx_pos_c473b54ae7dfc372_536_new)
HXLINE( 537)		this->name = name;
HXLINE( 538)		this->frameRate = frameRate;
            	}
...
void FlxMetaData_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_c473b54ae7dfc372_541_destroy)
HXLINE( 542)		this->name = null();
HXLINE( 543)		this->frameRate = ( (Float)(0) );
            	}
