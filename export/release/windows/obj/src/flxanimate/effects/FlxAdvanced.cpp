...
HX_DEFINE_STACK_FRAME(_hx_pos_47b016349e73030e_10_new,"flxanimate.effects.FlxAdvanced","new",0xad052e5b,"flxanimate.effects.FlxAdvanced.new","flxanimate/effects/FlxAdvanced.hx",10,0xe0007df7)
HX_LOCAL_STACK_FRAME(_hx_pos_47b016349e73030e_17_get_colorTransform,"flxanimate.effects.FlxAdvanced","get_colorTransform",0x56714cb7,"flxanimate.effects.FlxAdvanced.get_colorTransform","flxanimate/effects/FlxAdvanced.hx",17,0xe0007df7)
...
void FlxAdvanced_obj::__construct( ::openfl::geom::ColorTransform colorTransform){
            	HX_STACKFRAME(&_hx_pos_47b016349e73030e_10_new)
HXLINE(  11)		super::__construct();
HXLINE(  12)		this->set_colorTransform(colorTransform);
            	}
...
bool FlxAdvanced_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::geom::ColorTransform FlxAdvanced_obj::get_colorTransform(){
            	HX_STACKFRAME(&_hx_pos_47b016349e73030e_17_get_colorTransform)
HXDLIN(  17)		return this->c_Transform;
            	}
...
HXDLIN(  21)		return (this->c_Transform = value);
            	}
