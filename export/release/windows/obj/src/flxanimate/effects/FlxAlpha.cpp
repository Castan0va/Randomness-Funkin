...
HX_LOCAL_STACK_FRAME(_hx_pos_e8a03002fe0cf485_15_process,"flxanimate.effects.FlxAlpha","process",0x3ccf1cb8,"flxanimate.effects.FlxAlpha.process","flxanimate/effects/FlxAlpha.hx",15,0x24a417a5)
HX_LOCAL_STACK_FRAME(_hx_pos_e8a03002fe0cf485_18_set_alpha,"flxanimate.effects.FlxAlpha","set_alpha",0xd9df4e4a,"flxanimate.effects.FlxAlpha.set_alpha","flxanimate/effects/FlxAlpha.hx",18,0x24a417a5)
...
HXLINE(  10)		this->set_alpha(alpha);
            	}
...
void FlxAlpha_obj::process(){
            	HX_STACKFRAME(&_hx_pos_e8a03002fe0cf485_15_process)
HXDLIN(  15)		this->c_Transform->alphaMultiplier = this->alpha;
            	}


Float FlxAlpha_obj::set_alpha(Float value){
            	HX_STACKFRAME(&_hx_pos_e8a03002fe0cf485_18_set_alpha)
HXLINE(  19)		if ((this->alpha != value)) {
HXLINE(  19)			this->renderDirty = true;
            		}
HXLINE(  21)		return (this->alpha = value);
            	}
