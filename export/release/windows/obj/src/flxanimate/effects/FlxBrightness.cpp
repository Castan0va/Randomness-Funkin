...
HX_LOCAL_STACK_FRAME(_hx_pos_a265cf83130bb21a_13_process,"flxanimate.effects.FlxBrightness","process",0x267ee4d9,"flxanimate.effects.FlxBrightness.process","flxanimate/effects/FlxBrightness.hx",13,0x8d423de8)
HX_LOCAL_STACK_FRAME(_hx_pos_a265cf83130bb21a_21_set_brightness,"flxanimate.effects.FlxBrightness","set_brightness",0x45223d64,"flxanimate.effects.FlxBrightness.set_brightness","flxanimate/effects/FlxBrightness.hx",21,0x8d423de8)
...
HXLINE(  10)		this->set_brightness(brightness);
            	}
...
void FlxBrightness_obj::process(){
            	HX_STACKFRAME(&_hx_pos_a265cf83130bb21a_13_process)
HXLINE(  14)		this->c_Transform->redMultiplier = (this->c_Transform->greenMultiplier = (this->c_Transform->blueMultiplier = (( (Float)(1) ) - ::Math_obj::abs(this->brightness))));
HXLINE(  16)		if ((this->brightness >= 0)) {
HXLINE(  17)			this->c_Transform->redOffset = (this->c_Transform->greenOffset = (this->c_Transform->blueOffset = (( (Float)(255) ) * this->brightness)));
            		}
            	}


Float FlxBrightness_obj::set_brightness(Float value){
            	HX_STACKFRAME(&_hx_pos_a265cf83130bb21a_21_set_brightness)
HXLINE(  22)		if ((this->brightness != value)) {
HXLINE(  22)			this->renderDirty = true;
            		}
HXLINE(  24)		return (this->brightness = value);
            	}
