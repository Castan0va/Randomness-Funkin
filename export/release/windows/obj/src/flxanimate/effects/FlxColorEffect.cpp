...
HX_LOCAL_STACK_FRAME(_hx_pos_05be9081e4a44dad_33_process,"flxanimate.effects.FlxColorEffect","process",0xe60dd06e,"flxanimate.effects.FlxColorEffect.process","flxanimate/effects/FlxColorEffect.hx",33,0x519a422f)
HX_LOCAL_STACK_FRAME(_hx_pos_05be9081e4a44dad_40___create,"flxanimate.effects.FlxColorEffect","__create",0x5a43e33d,"flxanimate.effects.FlxColorEffect.__create","flxanimate/effects/FlxColorEffect.hx",40,0x519a422f)
namespace flxanimate{
namespace effects{

void FlxColorEffect_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_05be9081e4a44dad_13_new)
HXLINE(  23)		this->c_Transform = null();
HXLINE(  18)		this->renderDirty = true;
            	}
...
void FlxColorEffect_obj::process(){
            	HX_STACKFRAME(&_hx_pos_05be9081e4a44dad_33_process)
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(FlxColorEffect_obj,process,(void))
 ...
 ::openfl::geom::ColorTransform FlxColorEffect_obj::_hx___create(){
            	HX_GC_STACKFRAME(&_hx_pos_05be9081e4a44dad_40___create)
HXLINE(  41)		if (!(this->renderDirty)) {
HXLINE(  41)			return this->c_Transform;
            		}
HXLINE(  43)		if (::hx::IsNull( this->c_Transform )) {
HXLINE(  44)			this->c_Transform =  ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null());
            		}
HXLINE(  47)		this->process();
HXLINE(  48)		this->renderDirty = false;
HXLINE(  51)		return this->c_Transform;
            	}
