...
HX_DEFINE_STACK_FRAME(_hx_pos_92f60814d97055ad_621_new,"flxanimate.filters._BevelFilter.FullCombineShader","new",0xa65bfebe,"flxanimate.filters._BevelFilter.FullCombineShader.new","flxanimate/filters/BevelFilter.hx",621,0xf3eb9040)
namespace flxanimate{
namespace filters{
namespace _BevelFilter{

void FullCombineShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_92f60814d97055ad_621_new)
...
HXLINE( 622)		super::__construct();
HXLINE( 605)		this->_hx___isGenerated = true;
HXDLIN( 605)		this->_hx___initGL();
            	}
