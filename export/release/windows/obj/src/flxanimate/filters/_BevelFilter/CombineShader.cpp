...
HX_DEFINE_STACK_FRAME(_hx_pos_893c7bf91056a8fc_670_new,"flxanimate.filters._BevelFilter.CombineShader","new",0xcaf8a1cd,"flxanimate.filters._BevelFilter.CombineShader.new","flxanimate/filters/BevelFilter.hx",670,0xf3eb9040)
namespace flxanimate{
namespace filters{
namespace _BevelFilter{

void CombineShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_893c7bf91056a8fc_670_new)
...
HXLINE( 671)		super::__construct();
HXLINE( 654)		this->_hx___isGenerated = true;
HXDLIN( 654)		this->_hx___initGL();
            	}
