...
HX_LOCAL_STACK_FRAME(_hx_pos_b504f1b291c3a690_376___updateSize,"flxanimate.filters.BevelFilter","__updateSize",0x33fcb8b8,"flxanimate.filters.BevelFilter.__updateSize","flxanimate/filters/BevelFilter.hx",376,0xf3eb9040)
...
HXDLIN( 340)			if ((pass == ((this->_hx___horizontalPasses + this->_hx___verticalPasses) - 1))) {
HXLINE( 340)				_hx_tmp = this->_hx___strength;
            			}
            			else {
HXLINE( 340)				_hx_tmp = ((Float)1.0);
            			}
HXDLIN( 340)			shader->uStrength->value[0] = _hx_tmp;
...
HXLINE( 365)			int _hx_tmp1;
HXDLIN( 365)			if (this->_hx___knockout) {
HXLINE( 365)				_hx_tmp1 = 1;
            			}
            			else {
HXLINE( 365)				_hx_tmp1 = 0;
            			}
HXDLIN( 365)			shader1->knockout->value[0] = _hx_tmp1;
HXLINE( 366)			shader1->offset->value[0] = this->_hx___offsetX;
HXLINE( 367)			shader1->offset->value[1] = this->_hx___offsetY;
            		}
HXLINE( 370)		return shader1;
            	}


void BevelFilter_obj::_hx___updateSize(){
            	HX_STACKFRAME(&_hx_pos_b504f1b291c3a690_376___updateSize)
HXLINE( 377)		bool inner = (this->get_type() == HX_("inner",96,31,1c,be));
