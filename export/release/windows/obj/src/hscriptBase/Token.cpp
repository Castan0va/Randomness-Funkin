...
{
	return ::hx::CreateEnum< Token_obj >(HX_("TMeta",39,31,db,90),19,1)->_hx_init(0,s);
}
...
{
	return ::hx::CreateEnum< Token_obj >(HX_("TPrepro",5e,e3,5d,88),20,1)->_hx_init(0,s);
}

::hscriptBase::Token Token_obj::TQDot;

::hscriptBase::Token Token_obj::TQDouble;

::hscriptBase::Token Token_obj::TQDoubleAssign;
...
bool Token_obj::__GetStatic(const ::String &inName, ::Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	if (inName==HX_("TQDot",0c,fd,66,93)) { outValue = Token_obj::TQDot; return true; }
	if (inName==HX_("TQDouble",6e,a4,37,54)) { outValue = Token_obj::TQDouble; return true; }
	if (inName==HX_("TQDoubleAssign",3d,65,5e,f6)) { outValue = Token_obj::TQDoubleAssign; return true; }
...
int Token_obj::__FindIndex(::String inName)
{
	...
	if (inName==HX_("TPrepro",5e,e3,5d,88)) return 20;
	if (inName==HX_("TQDot",0c,fd,66,93)) return 14;
	if (inName==HX_("TQDouble",6e,a4,37,54)) return 15;
	if (inName==HX_("TQDoubleAssign",3d,65,5e,f6)) return 16;
	if (inName==HX_("TQuestion",9a,cb,98,37)) return 17;
...
int Token_obj::__FindArgCount(::String inName)
{
	...
	if (inName==HX_("TQDot",0c,fd,66,93)) return 0;
	if (inName==HX_("TQDouble",6e,a4,37,54)) return 0;
	if (inName==HX_("TQDoubleAssign",3d,65,5e,f6)) return 0;
...
::hx::Val Token_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	if (inName==HX_("TQDot",0c,fd,66,93)) return TQDot;
	if (inName==HX_("TQDouble",6e,a4,37,54)) return TQDouble;
	if (inName==HX_("TQDoubleAssign",3d,65,5e,f6)) return TQDoubleAssign;
...
static ::String Token_obj_sStaticFields[] = {
	...
	HX_("TQDot",0c,fd,66,93),
	HX_("TQDouble",6e,a4,37,54),
	HX_("TQDoubleAssign",3d,65,5e,f6),
...
TDoubleDot = ::hx::CreateConstEnum< Token_obj >(HX_("TDoubleDot",04,85,f4,8f),18);
...
TQDot = ::hx::CreateConstEnum< Token_obj >(HX_("TQDot",0c,fd,66,93),14);
TQDouble = ::hx::CreateConstEnum< Token_obj >(HX_("TQDouble",6e,a4,37,54),15);
TQDoubleAssign = ::hx::CreateConstEnum< Token_obj >(HX_("TQDoubleAssign",3d,65,5e,f6),16);
TQuestion = ::hx::CreateConstEnum< Token_obj >(HX_("TQuestion",9a,cb,98,37),17);
