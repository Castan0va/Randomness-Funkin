...
HX_DEFINE_STACK_FRAME(_hx_pos_075cb0bf2a0063a1_100_new,"hscriptBase.Error","new",0x375b45d0,"hscriptBase.Error.new","hscriptBase/Expr.hx",100,0x6543ea5e)
HX_LOCAL_STACK_FRAME(_hx_pos_075cb0bf2a0063a1_108_toString,"hscriptBase.Error","toString",0xb137a53c,"hscriptBase.Error.toString","hscriptBase/Expr.hx",108,0x6543ea5e)
namespace hscriptBase{

void Error_obj::__construct( ::hscriptBase::ErrorDef e,int pmin,int pmax,::String origin,int line){
            	HX_STACKFRAME(&_hx_pos_075cb0bf2a0063a1_100_new)
HXLINE( 101)		this->e = e;
HXLINE( 102)		this->pmin = pmin;
HXLINE( 103)		this->pmax = pmax;
HXLINE( 104)		this->origin = origin;
HXLINE( 105)		this->line = line;
            	}
...
::String Error_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_075cb0bf2a0063a1_108_toString)
HXDLIN( 108)		return ::hscriptBase::Printer_obj::errorToString(::hx::ObjectPtr<OBJ_>(this));
            	}
