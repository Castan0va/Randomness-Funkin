...
{
	return ::hx::CreateEnum< ExprDef_obj >(HX_("EArray",14,c3,5c,4f),20,2)->_hx_init(0,e)->_hx_init(1,index);
}

::hscriptBase::ExprDef ExprDef_obj::EArrayDecl(::Array< ::Dynamic> e)
{
	return ::hx::CreateEnum< ExprDef_obj >(HX_("EArrayDecl",9e,59,bd,01),21,1)->_hx_init(0,e);
}
...
{
	return ::hx::CreateEnum< ExprDef_obj >(HX_("ECheckType",9d,ea,cd,16),34,2)->_hx_init(0,e)->_hx_init(1,t);
}

::hscriptBase::ExprDef ExprDef_obj::ECoalesce( ::Dynamic e1, ::Dynamic e2,bool assign)
{
	return ::hx::CreateEnum< ExprDef_obj >(HX_("ECoalesce",0c,76,12,16),14,3)->_hx_init(0,e1)->_hx_init(1,e2)->_hx_init(2,assign);
}
...
{
	return ::hx::CreateEnum< ExprDef_obj >(HX_("EDoWhile",61,0e,d4,34),28,2)->_hx_init(0,cond)->_hx_init(1,e);
}
...
::hscriptBase::ExprDef ExprDef_obj::EFinal(::String f, ::hscriptBase::CType t, ::Dynamic e)
{
	return ::hx::CreateEnum< ExprDef_obj >(HX_("EFinal",f1,b4,67,2a),3,3)->_hx_init(0,f)->_hx_init(1,t)->_hx_init(2,e);
}
...
::hscriptBase::ExprDef ExprDef_obj::EFunction(::Array< ::Dynamic> args, ::Dynamic e,::String name, ::hscriptBase::CType ret, ::Dynamic d)
{
	return ::hx::CreateEnum< ExprDef_obj >(HX_("EFunction",7d,b4,15,c9),18,5)->_hx_init(0,args)->_hx_init(1,e)->_hx_init(2,name)->_hx_init(3,ret)->_hx_init(4,d);
}
...
::hscriptBase::ExprDef ExprDef_obj::EImport( ::Dynamic i,::String c,::String asIdent)
{
	return ::hx::CreateEnum< ExprDef_obj >(HX_("EImport",8a,17,60,72),30,3)->_hx_init(0,i)->_hx_init(1,c)->_hx_init(2,asIdent);
}

::hscriptBase::ExprDef ExprDef_obj::EImportStar(::String pkg)
{
	return ::hx::CreateEnum< ExprDef_obj >(HX_("EImportStar",7c,b4,38,06),31,1)->_hx_init(0,pkg);
}

::hscriptBase::ExprDef ExprDef_obj::EMeta(::String name,::Array< ::Dynamic> args, ::Dynamic e)
{
	return ::hx::CreateEnum< ExprDef_obj >(HX_("EMeta",aa,7d,d8,ed),33,3)->_hx_init(0,name)->_hx_init(1,args)->_hx_init(2,e);
}

::hscriptBase::ExprDef ExprDef_obj::ENew(::String cl,::Array< ::Dynamic> params,::Array< ::String > subIds)
{
	return ::hx::CreateEnum< ExprDef_obj >(HX_("ENew",1b,41,d7,2d),22,3)->_hx_init(0,cl)->_hx_init(1,params)->_hx_init(2,subIds);
}

::hscriptBase::ExprDef ExprDef_obj::EObject(::Array< ::Dynamic> fl)
{
	return ::hx::CreateEnum< ExprDef_obj >(HX_("EObject",e4,f4,1c,7f),25,1)->_hx_init(0,fl);
}

::hscriptBase::ExprDef ExprDef_obj::EPackage(::String p)
{
	return ::hx::CreateEnum< ExprDef_obj >(HX_("EPackage",c1,15,9b,79),32,1)->_hx_init(0,p);
}
...
::hscriptBase::ExprDef ExprDef_obj::ESafeNavigator( ::Dynamic e1,::String f)
{
	return ::hx::CreateEnum< ExprDef_obj >(HX_("ESafeNavigator",45,6e,6d,dc),15,2)->_hx_init(0,e1)->_hx_init(1,f);
}

::hscriptBase::ExprDef ExprDef_obj::ESwitch( ::Dynamic e,::Array< ::Dynamic> cases, ::Dynamic defaultExpr)
{
	return ::hx::CreateEnum< ExprDef_obj >(HX_("ESwitch",19,c0,56,2f),27,3)->_hx_init(0,e)->_hx_init(1,cases)->_hx_init(2,defaultExpr);
}

::hscriptBase::ExprDef ExprDef_obj::ESwitchBinop( ::Dynamic p, ::Dynamic e1, ::Dynamic e2)
{
	return ::hx::CreateEnum< ExprDef_obj >(HX_("ESwitchBinop",cf,ce,4a,43),8,3)->_hx_init(0,p)->_hx_init(1,e1)->_hx_init(2,e2);
}

::hscriptBase::ExprDef ExprDef_obj::ETernary( ::Dynamic cond, ::Dynamic e1, ::Dynamic e2)
{
	return ::hx::CreateEnum< ExprDef_obj >(HX_("ETernary",56,c3,5c,5e),26,3)->_hx_init(0,cond)->_hx_init(1,e1)->_hx_init(2,e2);
}
...
{
	return ::hx::CreateEnum< ExprDef_obj >(HX_("ETry",f6,d9,db,2d),24,4)->_hx_init(0,e)->_hx_init(1,v)->_hx_init(2,t)->_hx_init(3,ecatch);
}
...
{
	return ::hx::CreateEnum< ExprDef_obj >(HX_("EUsing",bf,ca,02,d4),29,2)->_hx_init(0,op)->_hx_init(1,n);
}

::hscriptBase::ExprDef ExprDef_obj::EVar(::String n, ::hscriptBase::CType t, ::Dynamic e,::Array< ::String > g)
{
	return ::hx::CreateEnum< ExprDef_obj >(HX_("EVar",a2,4f,dd,2d),2,4)->_hx_init(0,n)->_hx_init(1,t)->_hx_init(2,e)->_hx_init(3,g);
}
...
bool ExprDef_obj::__GetStatic(const ::String &inName, ::Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	if (inName==HX_("EImportStar",7c,b4,38,06)) { outValue = ExprDef_obj::EImportStar_dyn(); return true; }
	...
	if (inName==HX_("ESafeNavigator",45,6e,6d,dc)) { outValue = ExprDef_obj::ESafeNavigator_dyn(); return true; }
	if (inName==HX_("ESwitch",19,c0,56,2f)) { outValue = ExprDef_obj::ESwitch_dyn(); return true; }
	if (inName==HX_("ESwitchBinop",cf,ce,4a,43)) { outValue = ExprDef_obj::ESwitchBinop_dyn(); return true; }
...
{
	if (inName==HX_("EArray",14,c3,5c,4f)) return 20;
	if (inName==HX_("EArrayDecl",9e,59,bd,01)) return 21;
	if (inName==HX_("EBinop",23,6f,cd,dc)) return 7;
	if (inName==HX_("EBlock",c8,ca,c9,de)) return 5;
	if (inName==HX_("EBreak",3a,7a,b9,e2)) return 16;
	if (inName==HX_("ECall",83,4b,39,e7)) return 10;
	if (inName==HX_("ECheckType",9d,ea,cd,16)) return 34;
	if (inName==HX_("ECoalesce",0c,76,12,16)) return 14;
	if (inName==HX_("EConst",de,4e,2b,74)) return 0;
	if (inName==HX_("EContinue",cc,e9,8b,e6)) return 17;
	if (inName==HX_("EDoWhile",61,0e,d4,34)) return 28;
	...
	if (inName==HX_("EFunction",7d,b4,15,c9)) return 18;
	if (inName==HX_("EIdent",6b,98,46,e1)) return 1;
	if (inName==HX_("EIf",82,9b,34,00)) return 11;
	if (inName==HX_("EImport",8a,17,60,72)) return 30;
	if (inName==HX_("EImportStar",7c,b4,38,06)) return 31;
	if (inName==HX_("EMeta",aa,7d,d8,ed)) return 33;
	if (inName==HX_("ENew",1b,41,d7,2d)) return 22;
	if (inName==HX_("EObject",e4,f4,1c,7f)) return 25;
	if (inName==HX_("EPackage",c1,15,9b,79)) return 32;
	if (inName==HX_("EParent",4f,7b,5b,57)) return 4;
	if (inName==HX_("EReturn",d5,1a,0b,73)) return 19;
	if (inName==HX_("ESafeNavigator",45,6e,6d,dc)) return 15;
	if (inName==HX_("ESwitch",19,c0,56,2f)) return 27;
	if (inName==HX_("ESwitchBinop",cf,ce,4a,43)) return 8;
	if (inName==HX_("ETernary",56,c3,5c,5e)) return 26;
	if (inName==HX_("EThrow",a1,b2,5d,39)) return 23;
	if (inName==HX_("ETry",f6,d9,db,2d)) return 24;
	if (inName==HX_("EUnop",9f,02,29,f3)) return 9;
	if (inName==HX_("EUsing",bf,ca,02,d4)) return 29;
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(ExprDef_obj,EFinal,return)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(ExprDef_obj,EImportStar,return)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(ExprDef_obj,ESafeNavigator,return)

STATIC_HX_DEFINE_DYNAMIC_FUNC3(ExprDef_obj,ESwitch,return)

STATIC_HX_DEFINE_DYNAMIC_FUNC3(ExprDef_obj,ESwitchBinop,return)
...
int ExprDef_obj::__FindArgCount(::String inName)
{
	...
	if (inName==HX_("EImportStar",7c,b4,38,06)) return 1;
	...
	if (inName==HX_("ESafeNavigator",45,6e,6d,dc)) return 2;
	if (inName==HX_("ESwitch",19,c0,56,2f)) return 3;
	if (inName==HX_("ESwitchBinop",cf,ce,4a,43)) return 3;
...
::hx::Val ExprDef_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	if (inName==HX_("EImportStar",7c,b4,38,06)) return EImportStar_dyn();
	...
	if (inName==HX_("ESafeNavigator",45,6e,6d,dc)) return ESafeNavigator_dyn();
	if (inName==HX_("ESwitch",19,c0,56,2f)) return ESwitch_dyn();
	if (inName==HX_("ESwitchBinop",cf,ce,4a,43)) return ESwitchBinop_dyn();
...
static ::String ExprDef_obj_sStaticFields[] = {
	...
	HX_("ESafeNavigator",45,6e,6d,dc),
...
{
EBreak = ::hx::CreateConstEnum< ExprDef_obj >(HX_("EBreak",3a,7a,b9,e2),16);
EContinue = ::hx::CreateConstEnum< ExprDef_obj >(HX_("EContinue",cc,e9,8b,e6),17);
}
