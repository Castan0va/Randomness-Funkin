...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("Random",23,96,23,ec),::ApplicationMain_obj::create_dyn());
...
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("Random",23,96,23,ec));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Randomness Funkin",77,f5,c5,3f));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Randomness Funkin",77,f5,c5,3f))
