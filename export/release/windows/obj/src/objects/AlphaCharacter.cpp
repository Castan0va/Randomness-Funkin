...
HXDLIN( 420)			 ::flixel::graphics::FlxGraphic imageLoaded = ::backend::Paths_obj::image(name,library,true);
...
HXLINE( 420)				_hx_tmp = ::sys::io::File_obj::getContent(xml);
            			}
            			else {
HXLINE( 420)				_hx_tmp = ::backend::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + name) + HX_(".xml",69,3e,c3,1e)),null(),library,null());
            			}
HXDLIN( 420)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(imageLoaded,_hx_tmp));
...
HXLINE( 430)		::String library1 = null();
HXDLIN( 430)		 ::flixel::graphics::FlxGraphic imageLoaded1 = ::backend::Paths_obj::image(name,library1,true);
HXDLIN( 430)		bool xmlExists1 = false;
HXDLIN( 430)		::String xml1 = ::backend::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + name) + HX_(".xml",69,3e,c3,1e)));
HXDLIN( 430)		if (::sys::FileSystem_obj::exists(xml1)) {
HXLINE( 430)			xmlExists1 = true;
            		}
HXDLIN( 430)		 ::Dynamic _hx_tmp1;
HXDLIN( 430)		if (xmlExists1) {
HXLINE( 430)			_hx_tmp1 = ::sys::io::File_obj::getContent(xml1);
            		}
            		else {
HXLINE( 430)			_hx_tmp1 = ::backend::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + name) + HX_(".xml",69,3e,c3,1e)),null(),library1,null());
            		}
HXDLIN( 430)		this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(imageLoaded1,_hx_tmp1));
...
HXLINE( 465)				_hx_tmp1 = ::hx::IsNotNull( this->curLetter->__Field(HX_("offsets",80,09,65,d7),::hx::paccDynamic) );
            			}
            			else {
