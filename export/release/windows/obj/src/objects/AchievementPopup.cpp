...
HXLINE(  61)				name = ( (::String)(achievement->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic)) );
            			}
HXLINE(  62)			if (::hx::IsNotNull( achievement->__Field(HX_("description",fc,08,1d,5f),::hx::paccDynamic) )) {
HXLINE(  62)				desc = ( (::String)(achievement->__Field(HX_("description",fc,08,1d,5f),::hx::paccDynamic)) );
            			}
            		}
