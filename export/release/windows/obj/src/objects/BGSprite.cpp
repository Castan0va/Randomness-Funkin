...
HXDLIN(  10)			 ::flixel::graphics::FlxGraphic imageLoaded = ::backend::Paths_obj::image(image,library,true);
...
HXLINE(  10)				_hx_tmp = ::backend::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + image) + HX_(".xml",69,3e,c3,1e)),null(),library,null());
            			}
