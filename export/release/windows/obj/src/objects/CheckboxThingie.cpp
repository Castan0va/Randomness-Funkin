...
HXDLIN(  13)		 ::flixel::graphics::FlxGraphic imageLoaded = ::backend::Paths_obj::image(HX_("checkboxanim",d4,35,91,c5),library,true);
...
HXLINE(  13)			_hx_tmp = ::backend::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("checkboxanim",d4,35,91,c5)) + HX_(".xml",69,3e,c3,1e)),null(),library,null());
            		}
