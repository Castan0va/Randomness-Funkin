...
HXLINE(  32)		Float a = ((this->targetY * ( (Float)(120) )) + 480);
HXDLIN(  32)		this->set_y((a + (::Math_obj::exp((-(elapsed) * ((Float)10.2))) * (this->y - a))));
HXLINE(  33)		if (this->isFlashing) {
HXLINE(  35)			 ::objects::MenuItem _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  35)			_hx_tmp->_flashingElapsed = (_hx_tmp->_flashingElapsed + elapsed);
HXLINE(  36)			int _hx_tmp1;
HXDLIN(  36)			if ((::hx::Mod(::Math_obj::floor(((this->_flashingElapsed * ( (Float)(::flixel::FlxG_obj::updateFramerate) )) * ( (Float)(this->flashes_ps) ))),2) == 0)) {
HXLINE(  36)				_hx_tmp1 = this->_flashColor;
            			}
            			else {
HXLINE(  36)				_hx_tmp1 = -1;
            			}
HXDLIN(  36)			this->set_color(_hx_tmp1);
            		}
            	}
