...
HX_DEFINE_STACK_FRAME(_hx_pos_25c23e7e07a93d18_10_new,"objects.Alphabet","new",0xe6fd6f1f,"objects.Alphabet.new","objects/Alphabet.hx",10,0x083c86d0)
HX_LOCAL_STACK_FRAME(_hx_pos_25c23e7e07a93d18_42_setAlignmentFromString,"objects.Alphabet","setAlignmentFromString",0xf8f58cbd,"objects.Alphabet.setAlignmentFromString","objects/Alphabet.hx",42,0x083c86d0)
HX_LOCAL_STACK_FRAME(_hx_pos_25c23e7e07a93d18_54_set_alignment,"objects.Alphabet","set_alignment",0x90b4bc45,"objects.Alphabet.set_alignment","objects/Alphabet.hx",54,0x083c86d0)
HX_LOCAL_STACK_FRAME(_hx_pos_25c23e7e07a93d18_62_updateAlignment,"objects.Alphabet","updateAlignment",0xd204f4d9,"objects.Alphabet.updateAlignment","objects/Alphabet.hx",62,0x083c86d0)
HX_LOCAL_STACK_FRAME(_hx_pos_25c23e7e07a93d18_82_set_text,"objects.Alphabet","set_text",0x90f56e8b,"objects.Alphabet.set_text","objects/Alphabet.hx",82,0x083c86d0)
HX_LOCAL_STACK_FRAME(_hx_pos_25c23e7e07a93d18_92_clearLetters,"objects.Alphabet","clearLetters",0xc9cf6021,"objects.Alphabet.clearLetters","objects/Alphabet.hx",92,0x083c86d0)
HX_LOCAL_STACK_FRAME(_hx_pos_25c23e7e07a93d18_110_setScale,"objects.Alphabet","setScale",0x9ce6c469,"objects.Alphabet.setScale","objects/Alphabet.hx",110,0x083c86d0)
HX_LOCAL_STACK_FRAME(_hx_pos_25c23e7e07a93d18_125_set_scaleX,"objects.Alphabet","set_scaleX",0x2fb43fec,"objects.Alphabet.set_scaleX","objects/Alphabet.hx",125,0x083c86d0)
HX_LOCAL_STACK_FRAME(_hx_pos_25c23e7e07a93d18_136_set_scaleY,"objects.Alphabet","set_scaleY",0x2fb43fed,"objects.Alphabet.set_scaleY","objects/Alphabet.hx",136,0x083c86d0)
HX_LOCAL_STACK_FRAME(_hx_pos_25c23e7e07a93d18_147_softReloadLetters,"objects.Alphabet","softReloadLetters",0x324db629,"objects.Alphabet.softReloadLetters","objects/Alphabet.hx",147,0x083c86d0)
HX_LOCAL_STACK_FRAME(_hx_pos_25c23e7e07a93d18_163_update,"objects.Alphabet","update",0x5df268aa,"objects.Alphabet.update","objects/Alphabet.hx",163,0x083c86d0)
HX_LOCAL_STACK_FRAME(_hx_pos_25c23e7e07a93d18_177_snapToPosition,"objects.Alphabet","snapToPosition",0x56a3fbcf,"objects.Alphabet.snapToPosition","objects/Alphabet.hx",177,0x083c86d0)
HX_LOCAL_STACK_FRAME(_hx_pos_25c23e7e07a93d18_189_createLetters,"objects.Alphabet","createLetters",0x8cde98b0,"objects.Alphabet.createLetters","objects/Alphabet.hx",189,0x083c86d0)
HX_LOCAL_STACK_FRAME(_hx_pos_25c23e7e07a93d18_186_boot,"objects.Alphabet","boot",0x2edccc93,"objects.Alphabet.boot","objects/Alphabet.hx",186,0x083c86d0)
namespace objects{
...
void Alphabet_obj::__construct(Float x,Float y,::String __o_text, ::Dynamic __o_bold){
            	...
            	HX_STACKFRAME(&_hx_pos_25c23e7e07a93d18_10_new)
HXLINE(  28)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(0,0);
HXDLIN(  28)		point->_inPool = false;
HXDLIN(  28)		this->startPosition = point;
HXLINE(  27)		 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(20,120);
HXDLIN(  27)		point1->_inPool = false;
HXDLIN(  27)		this->distancePerItem = point1;
HXLINE(  25)		this->rows = 0;
HXLINE(  24)		this->scaleY = ((Float)1);
HXLINE(  23)		this->scaleX = ((Float)1);
HXLINE(  22)		this->alignment = ::objects::Alignment_obj::LEFT_dyn();
HXLINE(  20)		this->changeY = true;
HXLINE(  19)		this->changeX = true;
HXLINE(  18)		this->targetY = 0;
HXLINE(  17)		this->isMenuItem = false;
HXLINE(  15)		this->letters = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  14)		this->bold = false;
HXLINE(  32)		super::__construct(x,y,null());
HXLINE(  34)		this->startPosition->set_x(x);
HXLINE(  35)		this->startPosition->set_y(y);
HXLINE(  36)		this->bold = ( (bool)(bold) );
HXLINE(  37)		this->set_text(text);
            	}
...
void Alphabet_obj::setAlignmentFromString(::String align){
            	HX_STACKFRAME(&_hx_pos_25c23e7e07a93d18_42_setAlignmentFromString)
HXDLIN(  42)		::String _hx_switch_0 = ::StringTools_obj::trim(align.toLowerCase());
            		if (  (_hx_switch_0==HX_("center",d5,25,db,05)) ||  (_hx_switch_0==HX_("centered",74,5d,50,8f)) ){
HXLINE(  47)			this->set_alignment(::objects::Alignment_obj::CENTERED_dyn());
HXDLIN(  47)			goto _hx_goto_1;
            		}
            		if (  (_hx_switch_0==HX_("right",dc,0b,64,e9)) ){
HXLINE(  45)			this->set_alignment(::objects::Alignment_obj::RIGHT_dyn());
HXDLIN(  45)			goto _hx_goto_1;
            		}
            		/* default */{
HXLINE(  49)			this->set_alignment(::objects::Alignment_obj::LEFT_dyn());
            		}
            		_hx_goto_1:;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Alphabet_obj,setAlignmentFromString,(void))
 ...
 ::objects::Alignment Alphabet_obj::set_alignment( ::objects::Alignment align){
            	HX_STACKFRAME(&_hx_pos_25c23e7e07a93d18_54_set_alignment)
HXLINE(  55)		this->alignment = align;
HXLINE(  56)		this->updateAlignment();
HXLINE(  57)		return align;
            	}
...
void Alphabet_obj::updateAlignment(){
            	HX_STACKFRAME(&_hx_pos_25c23e7e07a93d18_62_updateAlignment)
HXDLIN(  62)		int _g = 0;
HXDLIN(  62)		::Array< ::Dynamic> _g1 = this->letters;
HXDLIN(  62)		while((_g < _g1->length)){
HXDLIN(  62)			 ::objects::AlphaCharacter letter = _g1->__get(_g).StaticCast<  ::objects::AlphaCharacter >();
HXDLIN(  62)			_g = (_g + 1);
HXLINE(  64)			Float newOffset = ( (Float)(0) );
HXLINE(  65)			switch((int)(this->alignment->_hx_getIndex())){
            				case (int)1: {
HXLINE(  68)					newOffset = (letter->rowWidth / ( (Float)(2) ));
            				}
            				break;
            				case (int)2: {
HXLINE(  70)					newOffset = letter->rowWidth;
            				}
            				break;
            				default:{
HXLINE(  72)					newOffset = ( (Float)(0) );
            				}
            			}
HXLINE(  75)			letter->offset->set_x((letter->offset->x - letter->alignOffset));
HXLINE(  76)			letter->alignOffset = (newOffset * this->scale->x);
...
::String Alphabet_obj::set_text(::String newText){
            	HX_STACKFRAME(&_hx_pos_25c23e7e07a93d18_82_set_text)
HXLINE(  83)		newText = ::StringTools_obj::replace(newText,HX_("\\n",92,50,00,00),HX_("\n",0a,00,00,00));
HXLINE(  84)		this->clearLetters();
HXLINE(  85)		this->createLetters(newText);
HXLINE(  86)		this->updateAlignment();
HXLINE(  87)		this->text = newText;
HXLINE(  88)		return newText;
            	}
...
void Alphabet_obj::clearLetters(){
            	HX_STACKFRAME(&_hx_pos_25c23e7e07a93d18_92_clearLetters)
HXLINE(  93)		int i = this->letters->length;
HXLINE(  94)		while((i > 0)){
HXLINE(  96)			i = (i - 1);
HXLINE(  97)			 ::objects::AlphaCharacter letter = this->letters->__get(i).StaticCast<  ::objects::AlphaCharacter >();
HXLINE(  98)			if (::hx::IsNotNull( letter )) {
HXLINE( 100)				letter->kill();
HXLINE( 101)				this->letters->remove(letter);
HXLINE( 102)				this->remove(letter,null());
            			}
            		}
HXLINE( 105)		this->letters = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 106)		this->rows = 0;
            	}
...
void Alphabet_obj::setScale(Float newX, ::Dynamic newY){
            	HX_STACKFRAME(&_hx_pos_25c23e7e07a93d18_110_setScale)
HXLINE( 111)		Float lastX = this->scale->x;
HXLINE( 112)		Float lastY = this->scale->y;
HXLINE( 113)		if (::hx::IsNull( newY )) {
HXLINE( 113)			newY = newX;
            		}
HXLINE( 115)		this->scaleX = newX;
HXLINE( 117)		this->scaleY = ( (Float)(newY) );
HXLINE( 119)		this->scale->set_x(newX);
HXLINE( 120)		this->scale->set_y(( (Float)(newY) ));
HXLINE( 121)		this->softReloadLetters((newX / lastX),(( (Float)(newY) ) / lastY));
            	}
...
Float Alphabet_obj::set_scaleX(Float value){
            	HX_STACKFRAME(&_hx_pos_25c23e7e07a93d18_125_set_scaleX)
HXLINE( 126)		if ((value == this->scaleX)) {
HXLINE( 126)			return value;
            		}
HXLINE( 128)		Float ratio = (value / this->scale->x);
HXLINE( 129)		this->scale->set_x(value);
HXLINE( 130)		this->scaleX = value;
HXLINE( 131)		this->softReloadLetters(ratio,1);
...
Float Alphabet_obj::set_scaleY(Float value){
            	HX_STACKFRAME(&_hx_pos_25c23e7e07a93d18_136_set_scaleY)
HXLINE( 137)		if ((value == this->scaleY)) {
HXLINE( 137)			return value;
            		}
HXLINE( 139)		Float ratio = (value / this->scale->y);
HXLINE( 140)		this->scale->set_y(value);
HXLINE( 141)		this->scaleY = value;
HXLINE( 142)		this->softReloadLetters(1,ratio);
...
void Alphabet_obj::softReloadLetters(::hx::Null< Float >  __o_ratioX, ::Dynamic ratioY){
            	...
            	HX_STACKFRAME(&_hx_pos_25c23e7e07a93d18_147_softReloadLetters)
HXLINE( 148)		if (::hx::IsNull( ratioY )) {
HXLINE( 148)			ratioY = ratioX;
            		}
HXLINE( 150)		{
HXLINE( 150)			int _g = 0;
HXDLIN( 150)			::Array< ::Dynamic> _g1 = this->letters;
HXDLIN( 150)			while((_g < _g1->length)){
HXLINE( 150)				 ::objects::AlphaCharacter letter = _g1->__get(_g).StaticCast<  ::objects::AlphaCharacter >();
HXDLIN( 150)				_g = (_g + 1);
HXLINE( 152)				if (::hx::IsNotNull( letter )) {
HXLINE( 154)					letter->setupAlphaCharacter((((letter->x - this->x) * ratioX) + this->x),(((letter->y - this->y) * ( (Float)(ratioY) )) + this->y),null(),null());
            				}
            			}
            		}
            	}
...
void Alphabet_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_25c23e7e07a93d18_163_update)
HXLINE( 164)		if (this->isMenuItem) {
HXLINE( 166)			Float lerpVal = ::Math_obj::exp((-(elapsed) * ((Float)9.6)));
HXLINE( 167)			if (this->changeX) {
HXLINE( 168)				Float a = ((( (Float)(this->targetY) ) * this->distancePerItem->x) + this->startPosition->x);
HXDLIN( 168)				this->set_x((a + (lerpVal * (this->x - a))));
            			}
HXLINE( 169)			if (this->changeY) {
HXLINE( 170)				Float a1 = (((( (Float)(this->targetY) ) * ((Float)1.3)) * this->distancePerItem->y) + this->startPosition->y);
HXDLIN( 170)				this->set_y((a1 + (lerpVal * (this->y - a1))));
            			}
            		}
...
void Alphabet_obj::snapToPosition(){
            	HX_STACKFRAME(&_hx_pos_25c23e7e07a93d18_177_snapToPosition)
HXDLIN( 177)		if (this->isMenuItem) {
HXLINE( 179)			if (this->changeX) {
HXLINE( 180)				this->set_x(((( (Float)(this->targetY) ) * this->distancePerItem->x) + this->startPosition->x));
            			}
HXLINE( 181)			if (this->changeY) {
HXLINE( 182)				this->set_y((((( (Float)(this->targetY) ) * ((Float)1.3)) * this->distancePerItem->y) + this->startPosition->y));
            			}
            		}
            	}
...
void Alphabet_obj::createLetters(::String newText){
            	HX_STACKFRAME(&_hx_pos_25c23e7e07a93d18_189_createLetters)
HXLINE( 190)		int consecutiveSpaces = 0;
HXLINE( 192)		Float xPos = ( (Float)(0) );
HXLINE( 193)		::Array< Float > rowData = ::Array_obj< Float >::__new(0);
HXLINE( 194)		this->rows = 0;
HXLINE( 195)		{
HXLINE( 195)			int _g = 0;
HXDLIN( 195)			::Array< ::String > _g1 = newText.split(HX_("",00,00,00,00));
HXDLIN( 195)			while((_g < _g1->length)){
HXLINE( 195)				::String character = _g1->__get(_g);
HXDLIN( 195)				_g = (_g + 1);
HXLINE( 198)				if ((character != HX_("\n",0a,00,00,00))) {
HXLINE( 200)					bool spaceChar;
HXDLIN( 200)					if ((character != HX_(" ",20,00,00,00))) {
HXLINE( 200)						if (this->bold) {
HXLINE( 200)							spaceChar = (character == HX_("_",5f,00,00,00));
            						}
            						else {
HXLINE( 200)							spaceChar = false;
            						}
            					}
            					else {
HXLINE( 200)						spaceChar = true;
            					}
HXLINE( 201)					if (spaceChar) {
HXLINE( 201)						consecutiveSpaces = (consecutiveSpaces + 1);
            					}
HXLINE( 203)					bool isAlphabet = ::objects::AlphaCharacter_obj::isTypeAlphabet(character.toLowerCase());
HXLINE( 204)					bool _hx_tmp;
HXDLIN( 204)					::Dynamic this1 = ::objects::AlphaCharacter_obj::allLetters;
HXDLIN( 204)					if (( ( ::haxe::ds::StringMap)(this1) )->exists(character.toLowerCase())) {
HXLINE( 204)						if (this->bold) {
HXLINE( 204)							_hx_tmp = !(spaceChar);
            						}
            						else {
...
HXLINE( 206)						if ((consecutiveSpaces > 0)) {
HXLINE( 208)							xPos = (xPos + (( (Float)((28 * consecutiveSpaces)) ) * this->scaleX));
HXLINE( 209)							rowData[this->rows] = xPos;
HXLINE( 210)							bool _hx_tmp1;
HXDLIN( 210)							if (!(this->bold)) {
HXLINE( 210)								_hx_tmp1 = (xPos >= (( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.65)));
            							}
            							else {
HXLINE( 210)								_hx_tmp1 = false;
            							}
HXDLIN( 210)							if (_hx_tmp1) {
HXLINE( 212)								xPos = ( (Float)(0) );
HXLINE( 213)								this->rows++;
            							}
            						}
HXLINE( 216)						consecutiveSpaces = 0;
HXLINE( 218)						 ::Dynamic ObjectFactory = null();
HXDLIN( 218)						 ::objects::AlphaCharacter letter = ( ( ::objects::AlphaCharacter)(this->group->recycle(::hx::ClassOf< ::objects::AlphaCharacter >(),ObjectFactory,true,true).StaticCast<  ::flixel::FlxSprite >()) );
HXLINE( 219)						letter->scale->set_x(this->scaleX);
HXLINE( 220)						letter->scale->set_y(this->scaleY);
HXLINE( 221)						letter->rowWidth = ( (Float)(0) );
...
HXLINE( 243)				 ::objects::AlphaCharacter letter1 = _g3->__get(_g2).StaticCast<  ::objects::AlphaCharacter >();
HXDLIN( 243)				_g2 = (_g2 + 1);
HXLINE( 245)				letter1->rowWidth = rowData->__get(letter1->row);
            			}
            		}
...
{
{
            	HX_STACKFRAME(&_hx_pos_25c23e7e07a93d18_186_boot)
HXDLIN( 186)		Y_PER_ROW = ((Float)85);
            	}
}
