...
HX_DEFINE_STACK_FRAME(_hx_pos_ea21d460f288a33b_905_new,"states.MenuButton","new",0xac67342f,"states.MenuButton.new","states/ModsMenuState.hx",905,0xd12771ea)
HX_LOCAL_STACK_FRAME(_hx_pos_ea21d460f288a33b_957_update,"states.MenuButton","update",0x61c52d9a,"states.MenuButton.update","states/ModsMenuState.hx",957,0xd12771ea)
HX_LOCAL_STACK_FRAME(_hx_pos_ea21d460f288a33b_981_set_onFocus,"states.MenuButton","set_onFocus",0x8f10b02b,"states.MenuButton.set_onFocus","states/ModsMenuState.hx",981,0xd12771ea)
HX_LOCAL_STACK_FRAME(_hx_pos_ea21d460f288a33b_989_set_enabled,"states.MenuButton","set_enabled",0x727ab673,"states.MenuButton.set_enabled","states/ModsMenuState.hx",989,0xd12771ea)
HX_LOCAL_STACK_FRAME(_hx_pos_ea21d460f288a33b_999_setButtonVisibility,"states.MenuButton","setButtonVisibility",0x3ab743f5,"states.MenuButton.setButtonVisibility","states/ModsMenuState.hx",999,0xd12771ea)
HX_LOCAL_STACK_FRAME(_hx_pos_ea21d460f288a33b_1022_centerOnBg,"states.MenuButton","centerOnBg",0x49f0054a,"states.MenuButton.centerOnBg","states/ModsMenuState.hx",1022,0xd12771ea)
namespace states{
...
void MenuButton_obj::__construct(Float x,Float y,int width,int height,::String text, ::flixel::graphics::FlxGraphic img, ::Dynamic onClick,::hx::Null< int >  __o_animWidth,::hx::Null< int >  __o_animHeight){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_ea21d460f288a33b_905_new)
HXLINE( 955)		this->_needACheck = false;
HXLINE( 954)		this->ignoreCheck = false;
HXLINE( 953)		this->onFocus = false;
HXLINE( 952)		this->focusChangeCallback = null();
HXLINE( 912)		this->enabled = true;
HXLINE( 911)		this->onClick = null();
HXLINE( 915)		super::__construct(x,y,null());
HXLINE( 917)		this->bg = ::flixel::util::FlxSpriteUtil_obj::drawRoundRect( ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null())->makeGraphic(width,height,0,null(),null()),( (Float)(0) ),( (Float)(0) ),( (Float)(width) ),( (Float)(height) ),( (Float)(15) ),( (Float)(15) ),-1,null(),null());
HXLINE( 918)		this->bg->set_color(-16777216);
HXLINE( 919)		this->add(this->bg);
HXLINE( 921)		if (::hx::IsNotNull( text )) {
HXLINE( 923)			this->textOn =  ::objects::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),HX_("",00,00,00,00),false);
HXLINE( 924)			this->textOn->setScale(((Float)0.6),null());
HXLINE( 925)			this->textOn->set_text(text);
HXLINE( 926)			this->textOn->set_alpha(((Float)0.6));
HXLINE( 927)			this->textOn->set_visible(false);
HXLINE( 928)			this->centerOnBg(this->textOn);
HXLINE( 929)			 ::objects::Alphabet fh = this->textOn;
HXDLIN( 929)			fh->set_y((fh->y - ( (Float)(30) )));
HXLINE( 930)			this->add(this->textOn);
HXLINE( 932)			this->textOff =  ::objects::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),HX_("",00,00,00,00),true);
HXLINE( 933)			this->textOff->setScale(((Float)0.52),null());
HXLINE( 934)			this->textOff->set_text(text);
HXLINE( 935)			this->textOff->set_alpha(((Float)0.6));
HXLINE( 936)			this->centerOnBg(this->textOff);
HXLINE( 937)			this->add(this->textOff);
            		}
            		else {
HXLINE( 939)			if (::hx::IsNotNull( img )) {
HXLINE( 941)				this->icon =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null());
HXLINE( 942)				bool _hx_tmp;
HXDLIN( 942)				if ((animWidth <= 0)) {
HXLINE( 942)					_hx_tmp = (animHeight > 0);
            				}
            				else {
HXLINE( 942)					_hx_tmp = true;
            				}
HXDLIN( 942)				if (_hx_tmp) {
HXLINE( 942)					this->icon->loadGraphic(img,true,animWidth,animHeight,null(),null());
            				}
            				else {
HXLINE( 943)					this->icon->loadGraphic(img,null(),null(),null(),null(),null());
            				}
HXLINE( 944)				this->centerOnBg(this->icon);
HXLINE( 945)				this->add(this->icon);
            			}
            		}
HXLINE( 948)		this->onClick = onClick;
HXLINE( 949)		this->setButtonVisibility(false);
            	}
...
void MenuButton_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_ea21d460f288a33b_957_update)
HXLINE( 958)		this->super::update(elapsed);
HXLINE( 960)		if (!(this->enabled)) {
HXLINE( 962)			this->set_onFocus(false);
HXLINE( 963)			return;
            		}
HXLINE( 966)		bool _hx_tmp;
HXDLIN( 966)		bool _hx_tmp1;
HXDLIN( 966)		bool _hx_tmp2;
HXDLIN( 966)		if (!(this->ignoreCheck)) {
HXLINE( 966)			_hx_tmp2 = !(::backend::Controls_obj::instance->controllerMode);
            		}
            		else {
HXLINE( 966)			_hx_tmp2 = false;
            		}
HXDLIN( 966)		if (_hx_tmp2) {
HXLINE( 966)			 ::flixel::input::mouse::FlxMouse _this = ::flixel::FlxG_obj::mouse;
HXDLIN( 966)			if ((_this->_prevX == _this->x)) {
HXLINE( 966)				_hx_tmp1 = (_this->_prevY != _this->y);
            			}
            			else {
...
HXLINE( 966)			_hx_tmp = ::flixel::FlxG_obj::mouse->visible;
            		}
            		else {
HXLINE( 966)			_hx_tmp = false;
            		}
HXDLIN( 966)		if (_hx_tmp) {
HXLINE( 967)			this->set_onFocus(::flixel::FlxG_obj::mouse->overlaps(::hx::ObjectPtr<OBJ_>(this),null()));
            		}
HXLINE( 969)		bool _hx_tmp3;
HXDLIN( 969)		bool _hx_tmp4;
HXDLIN( 969)		if (this->onFocus) {
HXLINE( 969)			_hx_tmp4 = ::hx::IsNotNull( this->onClick );
            		}
            		else {
HXLINE( 969)			_hx_tmp4 = false;
            		}
HXDLIN( 969)		if (_hx_tmp4) {
HXLINE( 969)			_hx_tmp3 = (::flixel::FlxG_obj::mouse->_leftButton->current == 2);
            		}
            		else {
HXLINE( 969)			_hx_tmp3 = false;
            		}
HXDLIN( 969)		if (_hx_tmp3) {
HXLINE( 970)			this->onClick();
            		}
HXLINE( 972)		if (this->_needACheck) {
HXLINE( 974)			this->_needACheck = false;
HXLINE( 975)			if (!(::backend::Controls_obj::instance->controllerMode)) {
HXLINE( 976)				this->setButtonVisibility(::flixel::FlxG_obj::mouse->overlaps(::hx::ObjectPtr<OBJ_>(this),null()));
            			}
            		}
            	}
...
bool MenuButton_obj::set_onFocus(bool newValue){
            	HX_STACKFRAME(&_hx_pos_ea21d460f288a33b_981_set_onFocus)
HXLINE( 982)		bool lastFocus = this->onFocus;
HXLINE( 983)		this->onFocus = newValue;
HXLINE( 984)		bool _hx_tmp;
HXDLIN( 984)		if ((this->onFocus != lastFocus)) {
HXLINE( 984)			_hx_tmp = this->enabled;
            		}
            		else {
HXLINE( 984)			_hx_tmp = false;
            		}
HXDLIN( 984)		if (_hx_tmp) {
HXLINE( 984)			this->setButtonVisibility(this->onFocus);
            		}
HXLINE( 985)		return newValue;
            	}
...
bool MenuButton_obj::set_enabled(bool newValue){
            	HX_STACKFRAME(&_hx_pos_ea21d460f288a33b_989_set_enabled)
HXLINE( 990)		this->enabled = newValue;
HXLINE( 991)		this->setButtonVisibility(false);
HXLINE( 992)		Float _hx_tmp;
HXDLIN( 992)		if (this->enabled) {
HXLINE( 992)			_hx_tmp = ( (Float)(1) );
            		}
            		else {
HXLINE( 992)			_hx_tmp = ((Float)0.4);
            		}
HXDLIN( 992)		this->set_alpha(_hx_tmp);
HXLINE( 994)		this->_needACheck = this->enabled;
HXLINE( 995)		return newValue;
            	}
...
void MenuButton_obj::setButtonVisibility(bool focusVal){
            	HX_STACKFRAME(&_hx_pos_ea21d460f288a33b_999_setButtonVisibility)
HXLINE(1000)		this->set_alpha(( (Float)(1) ));
HXLINE(1001)		int _hx_tmp;
HXDLIN(1001)		if (focusVal) {
HXLINE(1001)			_hx_tmp = -1;
            		}
            		else {
HXLINE(1001)			_hx_tmp = -16777216;
            		}
HXDLIN(1001)		this->bg->set_color(_hx_tmp);
HXLINE(1002)		Float _hx_tmp1;
HXDLIN(1002)		if (focusVal) {
HXLINE(1002)			_hx_tmp1 = ((Float)0.8);
            		}
            		else {
HXLINE(1002)			_hx_tmp1 = ((Float)0.6);
            		}
HXDLIN(1002)		this->bg->set_alpha(_hx_tmp1);
HXLINE(1004)		Float focusAlpha;
HXDLIN(1004)		if (focusVal) {
HXLINE(1004)			focusAlpha = ( (Float)(1) );
            		}
            		else {
HXLINE(1004)			focusAlpha = ((Float)0.6);
            		}
HXLINE(1005)		bool _hx_tmp2;
HXDLIN(1005)		if (::hx::IsNotNull( this->textOn )) {
HXLINE(1005)			_hx_tmp2 = ::hx::IsNotNull( this->textOff );
            		}
            		else {
HXLINE(1005)			_hx_tmp2 = false;
            		}
HXDLIN(1005)		if (_hx_tmp2) {
HXLINE(1007)			 ::objects::Alphabet _hx_tmp3 = this->textOn;
HXDLIN(1007)			_hx_tmp3->set_alpha(this->textOff->set_alpha(focusAlpha));
HXLINE(1008)			this->textOn->set_visible(focusVal);
HXLINE(1009)			this->textOff->set_visible(!(focusVal));
            		}
            		else {
HXLINE(1011)			if (::hx::IsNotNull( this->icon )) {
HXLINE(1013)				this->icon->set_alpha(focusAlpha);
HXLINE(1014)				int _hx_tmp4;
HXDLIN(1014)				if (focusVal) {
HXLINE(1014)					_hx_tmp4 = -16777216;
            				}
            				else {
HXLINE(1014)					_hx_tmp4 = -1;
            				}
HXDLIN(1014)				this->icon->set_color(_hx_tmp4);
            			}
            		}
HXLINE(1017)		if (!(this->enabled)) {
HXLINE(1017)			this->set_alpha(((Float)0.4));
            		}
HXLINE(1018)		if (::hx::IsNotNull( this->focusChangeCallback )) {
HXLINE(1018)			this->focusChangeCallback(focusVal);
            		}
            	}
...
void MenuButton_obj::centerOnBg( ::flixel::FlxSprite spr){
            	HX_STACKFRAME(&_hx_pos_ea21d460f288a33b_1022_centerOnBg)
HXLINE(1023)		Float _hx_tmp = (this->bg->get_width() / ( (Float)(2) ));
HXDLIN(1023)		spr->set_x((_hx_tmp - (spr->get_width() / ( (Float)(2) ))));
HXLINE(1024)		Float _hx_tmp1 = (this->bg->get_height() / ( (Float)(2) ));
HXDLIN(1024)		spr->set_y((_hx_tmp1 - (spr->get_height() / ( (Float)(2) ))));
            	}
