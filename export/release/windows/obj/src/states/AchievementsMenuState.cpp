...
HX_LOCAL_STACK_FRAME(_hx_pos_04e68d0d1b786c83_131_makeAchievement,"states.AchievementsMenuState","makeAchievement",0xf1dd3295,"states.AchievementsMenuState.makeAchievement","states/AchievementsMenuState.hx",131,0xe610951d)
HX_LOCAL_STACK_FRAME(_hx_pos_04e68d0d1b786c83_150_update,"states.AchievementsMenuState","update",0x9ec8fb15,"states.AchievementsMenuState.update","states/AchievementsMenuState.hx",150,0xe610951d)
HX_LOCAL_STACK_FRAME(_hx_pos_04e68d0d1b786c83_247__changeSelection,"states.AchievementsMenuState","_changeSelection",0x6e899749,"states.AchievementsMenuState._changeSelection","states/AchievementsMenuState.hx",247,0xe610951d)
HX_LOCAL_STACK_FRAME(_hx_pos_04e68d0d1b786c83_217__changeSelection,"states.AchievementsMenuState","_changeSelection",0x6e899749,"states.AchievementsMenuState._changeSelection","states/AchievementsMenuState.hx",217,0xe610951d)
...
HX_LOCAL_STACK_FRAME(_hx_pos_04e68d0d1b786c83_234__changeSelection,"states.AchievementsMenuState","_changeSelection",0x6e899749,"states.AchievementsMenuState._changeSelection","states/AchievementsMenuState.hx",234,0xe610951d)
HX_LOCAL_STACK_FRAME(_hx_pos_04e68d0d1b786c83_147_sortByID,"states.AchievementsMenuState","sortByID",0x6bf223fc,"states.AchievementsMenuState.sortByID","states/AchievementsMenuState.hx",147,0xe610951d)
namespace states{
...
HXLINE( 215)		this->barTween = null();
HXLINE( 149)		this->goingBack = false;
...
HXLINE(  29)		::backend::DiscordClient_obj::changePresence(HX_("Achievements Menu",1b,7e,30,71),null(),null(),null(),null());
HXLINE(  33)		{
...
HXLINE( 105)			_hx_tmp18 = (HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82));
            		}
HXDLIN( 105)		_hx_tmp17->setFormat(_hx_tmp18,24,-1,HX_("center",d5,25,db,05),null(),null(),null());
HXLINE( 106)		{
HXLINE( 106)			 ::flixel::math::FlxBasePoint this6 = this->descText->scrollFactor;
...
HXLINE( 110)		{
HXLINE( 110)			 ::flixel::math::FlxBasePoint this7 = this->progressBar->scrollFactor;
HXDLIN( 110)			this7->set_x(( (Float)(0) ));
HXDLIN( 110)			this7->set_y(( (Float)(0) ));
            		}
...
HXDLIN( 114)		::String file2 = ::backend::Paths_obj::modFolders((HX_("fonts/",eb,13,ef,fa) + HX_("vcr.ttf",9d,d2,a7,82)));
HXDLIN( 114)		::String _hx_tmp24;
HXDLIN( 114)		if (::sys::FileSystem_obj::exists(file2)) {
HXLINE( 114)			_hx_tmp24 = file2;
            		}
            		else {
HXLINE( 114)			_hx_tmp24 = (HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82));
            		}
...
HXLINE( 115)		{
HXLINE( 115)			 ::flixel::math::FlxBasePoint this8 = this->progressTxt->scrollFactor;
HXDLIN( 115)			this8->set_x(( (Float)(0) ));
HXDLIN( 115)			this8->set_y(( (Float)(0) ));
            		}
...
HXLINE( 126)		::flixel::FlxG_obj::camera->follow(this->camFollow,null(),9);
HXLINE( 127)		::flixel::FlxG_obj::camera->scroll->set_y(( (Float)(-(::flixel::FlxG_obj::height)) ));
 ...
 ::Dynamic AchievementsMenuState_obj::makeAchievement(::String achievement, ::Dynamic data,bool unlocked,::String mod){
            	HX_STACKFRAME(&_hx_pos_04e68d0d1b786c83_131_makeAchievement)
HXLINE( 132)		bool unlocked1 = ::backend::Achievements_obj::achievementsUnlocked->contains(achievement);
HXLINE( 135)		::String _hx_tmp;
HXDLIN( 135)		if (unlocked1) {
HXLINE( 135)			_hx_tmp = ( (::String)(data->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic)) );
            		}
            		else {
HXLINE( 135)			_hx_tmp = HX_("???",1f,05,30,00);
            		}
HXLINE( 136)		::String data1 = ( (::String)(data->__Field(HX_("description",fc,08,1d,5f),::hx::paccDynamic)) );
HXLINE( 137)		Float _hx_tmp1;
HXDLIN( 137)		if (::hx::IsGreater( data->__Field(HX_("maxScore",0e,c6,f6,22),::hx::paccDynamic),0 )) {
HXLINE( 137)			_hx_tmp1 = ::backend::Achievements_obj::getScore(achievement);
            		}
            		else {
HXLINE( 137)			_hx_tmp1 = ( (Float)(0) );
            		}
HXLINE( 138)		 ::Dynamic _hx_tmp2;
HXDLIN( 138)		if (::hx::IsGreater( data->__Field(HX_("maxScore",0e,c6,f6,22),::hx::paccDynamic),0 )) {
HXLINE( 138)			_hx_tmp2 = data->__Field(HX_("maxScore",0e,c6,f6,22),::hx::paccDynamic);
            		}
            		else {
HXLINE( 138)			_hx_tmp2 = 0;
            		}
HXLINE( 139)		 ::Dynamic _hx_tmp3;
HXDLIN( 139)		if (::hx::IsGreater( data->__Field(HX_("maxScore",0e,c6,f6,22),::hx::paccDynamic),0 )) {
HXLINE( 139)			_hx_tmp3 = data->__Field(HX_("maxDecimals",86,55,30,88),::hx::paccDynamic);
            		}
            		else {
HXLINE( 139)			_hx_tmp3 = 0;
            		}
HXLINE( 133)		return  ::Dynamic(::hx::Anon_obj::Create(9)
            			...
            			->setFixed(7,HX_("unlocked",23,34,0e,5c),unlocked1)
            			->setFixed(8,HX_("description",fc,08,1d,5f),data1));
            	}
...
void AchievementsMenuState_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_04e68d0d1b786c83_150_update)
HXLINE( 151)		bool _hx_tmp;
HXDLIN( 151)		if (!(this->goingBack)) {
HXLINE( 151)			_hx_tmp = (this->options->get_length() > 1);
            		}
            		else {
HXLINE( 151)			_hx_tmp = false;
            		}
HXDLIN( 151)		if (_hx_tmp) {
HXLINE( 153)			int add = 0;
HXLINE( 154)			if (this->get_controls()->get_UI_LEFT_P()) {
HXLINE( 154)				add = -1;
            			}
            			else {
HXLINE( 155)				if (this->get_controls()->get_UI_RIGHT_P()) {
HXLINE( 155)					add = 1;
            				}
            			}
HXLINE( 157)			if ((add != 0)) {
HXLINE( 159)				int oldRow = ::Math_obj::floor((( (Float)(this->curSelected) ) / ( (Float)(this->MAX_PER_ROW) )));
HXLINE( 160)				int rowSize = ::Std_obj::_hx_int(::Math_obj::min(( (Float)(this->MAX_PER_ROW) ),( (Float)((this->options->get_length() - (oldRow * this->MAX_PER_ROW))) )));
HXLINE( 162)				 ::states::AchievementsMenuState _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 162)				_hx_tmp1->curSelected = (_hx_tmp1->curSelected + add);
HXLINE( 163)				int curRow = ::Math_obj::floor((( (Float)(this->curSelected) ) / ( (Float)(this->MAX_PER_ROW) )));
HXLINE( 164)				if ((this->curSelected >= this->options->get_length())) {
HXLINE( 164)					curRow = (curRow + 1);
            				}
HXLINE( 166)				if ((curRow != oldRow)) {
HXLINE( 168)					if ((curRow < oldRow)) {
HXLINE( 168)						 ::states::AchievementsMenuState _hx_tmp2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 168)						_hx_tmp2->curSelected = (_hx_tmp2->curSelected + rowSize);
            					}
            					else {
HXLINE( 169)						 ::states::AchievementsMenuState _hx_tmp3 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 169)						_hx_tmp3->curSelected = (_hx_tmp3->curSelected - rowSize);
HXDLIN( 169)						this->curSelected = _hx_tmp3->curSelected;
            					}
            				}
HXLINE( 171)				this->_changeSelection();
            			}
HXLINE( 174)			if ((this->options->get_length() > this->MAX_PER_ROW)) {
HXLINE( 176)				int add1 = 0;
HXLINE( 177)				if (this->get_controls()->get_UI_UP_P()) {
HXLINE( 177)					add1 = -1;
            				}
            				else {
...
HXLINE( 180)				if ((add1 != 0)) {
HXLINE( 182)					int diff = (this->curSelected - (::Math_obj::floor((( (Float)(this->curSelected) ) / ( (Float)(this->MAX_PER_ROW) ))) * this->MAX_PER_ROW));
HXLINE( 183)					 ::states::AchievementsMenuState _hx_tmp4 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 183)					_hx_tmp4->curSelected = (_hx_tmp4->curSelected + (add1 * this->MAX_PER_ROW));
HXLINE( 185)					if ((this->curSelected < 0)) {
HXLINE( 187)						 ::states::AchievementsMenuState _hx_tmp5 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 187)						_hx_tmp5->curSelected = (_hx_tmp5->curSelected + (::Math_obj::ceil((( (Float)(this->options->get_length()) ) / ( (Float)(this->MAX_PER_ROW) ))) * this->MAX_PER_ROW));
HXLINE( 188)						if ((this->curSelected >= this->options->get_length())) {
HXLINE( 188)							 ::states::AchievementsMenuState _hx_tmp6 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 188)							_hx_tmp6->curSelected = (_hx_tmp6->curSelected - this->MAX_PER_ROW);
            						}
            					}
HXLINE( 191)					if ((this->curSelected >= this->options->get_length())) {
HXLINE( 193)						this->curSelected = diff;
            					}
HXLINE( 197)					this->_changeSelection();
            				}
            			}
HXLINE( 201)			bool _hx_tmp7;
HXDLIN( 201)			if (this->get_controls()->get_RESET()) {
HXLINE( 201)				if (!(( (bool)(this->options->__get(this->curSelected)->__Field(HX_("unlocked",23,34,0e,5c),::hx::paccDynamic)) ))) {
HXLINE( 201)					_hx_tmp7 = ::hx::IsGreater( this->options->__get(this->curSelected)->__Field(HX_("curProgress",4d,b9,69,07),::hx::paccDynamic),0 );
            				}
            				else {
...
HXLINE( 203)				this->openSubState( ::states::ResetAchievementSubstate_obj::__alloc( HX_CTX ));
            			}
            		}
HXLINE( 207)		if (this->get_controls()->get_BACK()) {
HXLINE( 208)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp8 = ::flixel::FlxG_obj::sound;
HXDLIN( 208)			_hx_tmp8->play(::backend::Paths_obj::sound(HX_("cancelMenu",39,a4,43,b7),null()),null(),null(),null(),null(),null());
HXLINE( 209)			::backend::MusicBeatState_obj::switchState( ::states::MainMenuState_obj::__alloc( HX_CTX ,null(),null()));
HXLINE( 210)			this->goingBack = true;
            		}
...
void AchievementsMenuState_obj::_changeSelection(){
            		...
            		void _hx_run( ::flixel::FlxSprite spr){
            			HX_STACKFRAME(&_hx_pos_04e68d0d1b786c83_247__changeSelection)
HXLINE( 248)			spr->set_alpha(((Float)0.6));
HXLINE( 249)			if ((spr->ID == _gthis->curSelected)) {
HXLINE( 249)				spr->set_alpha(( (Float)(1) ));
            			}
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_STACKFRAME(&_hx_pos_04e68d0d1b786c83_217__changeSelection)
HXDLIN( 217)		 ::states::AchievementsMenuState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 218)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 218)		_hx_tmp->play(::backend::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),null(),null(),null(),null(),null());
HXLINE( 219)		bool hasProgress = ::hx::IsGreater( this->options->__get(this->curSelected)->__Field(HX_("maxProgress",71,02,f1,fb),::hx::paccDynamic),0 );
HXLINE( 220)		this->nameText->set_text(( (::String)(this->options->__get(this->curSelected)->__Field(HX_("displayName",ad,11,f2,30),::hx::paccDynamic)) ));
HXLINE( 221)		this->descText->set_text(( (::String)(this->options->__get(this->curSelected)->__Field(HX_("description",fc,08,1d,5f),::hx::paccDynamic)) ));
HXLINE( 222)		 ::flixel::text::FlxText _hx_tmp1 = this->progressTxt;
HXDLIN( 222)		_hx_tmp1->set_visible(this->progressBar->set_visible(hasProgress));
HXLINE( 224)		if (::hx::IsNotNull( this->barTween )) {
HXLINE( 224)			this->barTween->cancel();
            		}
HXLINE( 226)		if (hasProgress) {
...
HXLINE( 233)				_gthis->progressBar->updateBar();
            			...
            			void _hx_run( ::flixel::tweens::FlxTween twn){
            				HX_STACKFRAME(&_hx_pos_04e68d0d1b786c83_234__changeSelection)
HXLINE( 234)				_gthis->progressBar->updateBar();
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE( 228)			Float val1 = ( (Float)(this->options->__get(this->curSelected)->__Field(HX_("curProgress",4d,b9,69,07),::hx::paccDynamic)) );
HXLINE( 229)			Float val2 = ( (Float)(this->options->__get(this->curSelected)->__Field(HX_("maxProgress",71,02,f1,fb),::hx::paccDynamic)) );
HXLINE( 230)			 ::flixel::text::FlxText _hx_tmp2 = this->progressTxt;
HXDLIN( 230)			::String _hx_tmp3 = (::backend::CoolUtil_obj::floorDecimal(val1,( (int)(this->options->__get(this->curSelected)->__Field(HX_("decProgress",8f,7f,7b,27),::hx::paccDynamic)) )) + HX_(" / ",31,71,18,00));
HXDLIN( 230)			_hx_tmp2->set_text((_hx_tmp3 + ::backend::CoolUtil_obj::floorDecimal(val2,( (int)(this->options->__get(this->curSelected)->__Field(HX_("decProgress",8f,7f,7b,27),::hx::paccDynamic)) ))));
HXLINE( 232)			this->barTween = ::flixel::tweens::FlxTween_obj::tween(this->progressBar, ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE( 237)			this->progressBar->set_percent(( (Float)(0) ));
            		}
HXLINE( 239)		int maxRows = ::Math_obj::floor((( (Float)(this->grpOptions->group->members->get_length()) ) / ( (Float)(this->MAX_PER_ROW) )));
HXLINE( 240)		if ((maxRows > 0)) {
HXLINE( 242)			Float camY = (( (Float)(::flixel::FlxG_obj::height) ) / ( (Float)(2) ));
HXDLIN( 242)			Float camY1 = (( (Float)(::Math_obj::floor((( (Float)(this->curSelected) ) / ( (Float)(this->MAX_PER_ROW) )))) ) / ( (Float)(maxRows) ));
HXDLIN( 242)			Float camY2 = this->grpOptions->get_height();
HXDLIN( 242)			Float camY3 = ((camY + (camY1 * ::Math_obj::max(( (Float)(0) ),((camY2 - (( (Float)(::flixel::FlxG_obj::height) ) / ( (Float)(2) ))) - ( (Float)(50) ))))) - ( (Float)(100) ));
HXLINE( 243)			this->camFollow->setPosition(0,camY3);
            		}
            		else {
HXLINE( 245)			 ::flixel::FlxObject _hx_tmp4 = this->camFollow;
HXDLIN( 245)			_hx_tmp4->setPosition(0,(Dynamic( this->grpOptions->group->members->__get(this->curSelected)).StaticCast<  ::flixel::FlxSprite >()->getGraphicMidpoint(null())->y - ( (Float)(100) )));
            		}
HXLINE( 247)		this->grpOptions->group->forEach( ::Dynamic(new _hx_Closure_2(_gthis)),false);
            	}
...
int AchievementsMenuState_obj::sortByID( ::Dynamic Obj1, ::Dynamic Obj2){
            	HX_STACKFRAME(&_hx_pos_04e68d0d1b786c83_147_sortByID)
HXDLIN( 147)		Float Value1 = ( (Float)(Obj1->__Field(HX_("ID",db,3f,00,00),::hx::paccDynamic)) );
HXDLIN( 147)		Float Value2 = ( (Float)(Obj2->__Field(HX_("ID",db,3f,00,00),::hx::paccDynamic)) );
HXDLIN( 147)		int result = 0;
HXDLIN( 147)		if ((Value1 < Value2)) {
HXDLIN( 147)			result = -1;
            		}
            		else {
HXDLIN( 147)			if ((Value1 > Value2)) {
