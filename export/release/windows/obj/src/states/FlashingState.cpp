...
HXDLIN(  29)				_this->set_x(((( (Float)(_hx_tmp1) ) - _this->get_width()) / ( (Float)(2) )));
            			}
HXDLIN(  29)			bool _hx_tmp2;
HXDLIN(  29)			if ((axes != 16)) {
HXLINE(  29)				_hx_tmp2 = (axes == 17);
            			}
            			else {
...
HXDLIN(  29)				_this->set_y(((( (Float)(_hx_tmp3) ) - _this->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXDLIN(  44)					_hx_tmp1->play(::backend::Paths_obj::sound(HX_("confirmMenu",bf,8e,fe,3c),null()),null(),null(),null(),null(),null());
...
HXLINE(  51)					 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp2 = ::flixel::FlxG_obj::sound;
HXDLIN(  51)					_hx_tmp2->play(::backend::Paths_obj::sound(HX_("cancelMenu",39,a4,43,b7),null()),null(),null(),null(),null(),null());
