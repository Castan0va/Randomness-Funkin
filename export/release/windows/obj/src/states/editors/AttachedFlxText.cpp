...
HX_DEFINE_STACK_FRAME(_hx_pos_81e9e9a8d436fb44_3241_new,"states.editors.AttachedFlxText","new",0xd2160e19,"states.editors.AttachedFlxText.new","states/editors/ChartingState.hx",3241,0x0f29a547)
HX_LOCAL_STACK_FRAME(_hx_pos_81e9e9a8d436fb44_3252_update,"states.editors.AttachedFlxText","update",0x86cfe1f0,"states.editors.AttachedFlxText.update","states/editors/ChartingState.hx",3252,0x0f29a547)
namespace states{
namespace editors{
...
void AttachedFlxText_obj::__construct(::hx::Null< Float >  __o_X,::hx::Null< Float >  __o_Y,::hx::Null< Float >  __o_FieldWidth,::String Text,::hx::Null< int >  __o_Size,::hx::Null< bool >  __o_EmbeddedFont){
            	...
            	HX_STACKFRAME(&_hx_pos_81e9e9a8d436fb44_3241_new)
HXLINE(3245)		this->yAdd = ((Float)0);
HXLINE(3244)		this->xAdd = ((Float)0);
HXLINE(3248)		super::__construct(X,Y,FieldWidth,Text,Size,EmbeddedFont);
            	}
...
void AttachedFlxText_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_81e9e9a8d436fb44_3252_update)
HXLINE(3253)		this->super::update(elapsed);
HXLINE(3255)		if (::hx::IsNotNull( this->sprTracker )) {
HXLINE(3256)			this->setPosition((this->sprTracker->x + this->xAdd),(this->sprTracker->y + this->yAdd));
HXLINE(3257)			this->set_angle(this->sprTracker->angle);
HXLINE(3258)			this->set_alpha(this->sprTracker->alpha);
            		}
            	}
