...
HXDLIN(  21)		 ::flixel::graphics::FlxGraphic imageLoaded = ::backend::Paths_obj::image(HX_("tankmanKilled1",04,7a,c5,c3),library,true);
...
HXLINE(  21)			_hx_tmp = ::backend::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("tankmanKilled1",04,7a,c5,c3)) + HX_(".xml",69,3e,c3,1e)),null(),library,null());
            		}
