...
HXDLIN(  11)		 ::flixel::graphics::FlxGraphic imageLoaded = ::backend::Paths_obj::image(HX_("limo/limoDancer",8e,b6,e5,ea),library,true);
...
HXLINE(  11)			_hx_tmp = ::backend::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("limo/limoDancer",8e,b6,e5,ea)) + HX_(".xml",69,3e,c3,1e)),null(),library,null());
            		}
