...
static const ::String _hx_array_data_914de52c_6[] = {
...
static const ::String _hx_array_data_914de52c_8[] = {
...
static const ::String _hx_array_data_914de52c_12[] = {
	HX_("blood",ba,7f,fc,b4),
};
...
HXLINE(  39)			this->bgLimo =  ::objects::BGSprite_obj::__alloc( HX_CTX ,HX_("limo/bgLimo",b4,c7,45,2c),-150,480,((Float)0.4),((Float)0.4),::Array_obj< ::String >::fromData( _hx_array_data_914de52c_3,1),true);
HXLINE(  40)			this->add(this->bgLimo);
HXLINE(  42)			this->limoCorpse =  ::objects::BGSprite_obj::__alloc( HX_CTX ,HX_("gore/noooooo",da,20,24,22),-500,(this->limoMetalPole->y - ( (Float)(130) )),((Float)0.4),((Float)0.4),::Array_obj< ::String >::fromData( _hx_array_data_914de52c_4,1),true);
HXLINE(  43)			this->add(this->limoCorpse);
HXLINE(  45)			this->limoCorpseTwo =  ::objects::BGSprite_obj::__alloc( HX_CTX ,HX_("gore/noooooo",da,20,24,22),-500,this->limoMetalPole->y,((Float)0.4),((Float)0.4),::Array_obj< ::String >::fromData( _hx_array_data_914de52c_5,1),true);
...
HXLINE(  51)			{
HXLINE(  51)				int _g = 0;
HXDLIN(  51)				while((_g < 5)){
HXLINE(  51)					_g = (_g + 1);
HXDLIN(  51)					int i = (_g - 1);
HXLINE(  53)					 ::states::stages::objects::BackgroundDancer dancer =  ::states::stages::objects::BackgroundDancer_obj::__alloc( HX_CTX ,(((370 * i) + this->dancersDiff) + this->bgLimo->x),(this->bgLimo->y - ( (Float)(400) )));
HXLINE(  54)					{
...
HXLINE(  65)			 ::objects::BGSprite particle =  ::objects::BGSprite_obj::__alloc( HX_CTX ,HX_("gore/stupidBlood",af,b8,f7,cb),-400,-400,((Float)0.4),((Float)0.4),::Array_obj< ::String >::fromData( _hx_array_data_914de52c_6,1),false);
...
HXLINE(  71)			::backend::Paths_obj::sound(HX_("dancerdeath",f5,1c,1c,c9),null());
...
HXLINE(  83)		 ::objects::BGSprite limo =  ::objects::BGSprite_obj::__alloc( HX_CTX ,HX_("limo/limoDrive",3b,67,64,e6),-120,550,1,1,::Array_obj< ::String >::fromData( _hx_array_data_914de52c_8,1),true);
...
HXDLIN( 111)											_hx_tmp1->play(::backend::Paths_obj::sound(HX_("dancerdeath",f5,1c,1c,c9),null()),((Float)0.5),null(),null(),null(),null());
            										}
...
HXLINE( 121)										 ::objects::BGSprite particle3 =  ::objects::BGSprite_obj::__alloc( HX_CTX ,HX_("gore/stupidBlood",af,b8,f7,cb),(dancers->__get(i).StaticCast<  ::states::stages::objects::BackgroundDancer >()->x - ( (Float)(110) )),(dancers->__get(i).StaticCast<  ::states::stages::objects::BackgroundDancer >()->y + 20),((Float)0.4),((Float)0.4),::Array_obj< ::String >::fromData( _hx_array_data_914de52c_12,1),false);
...
HXDLIN( 188)		if (( (bool)(this->game->__Field(HX_("paused",ae,40,84,ef),::hx::paccDynamic)) )) {
...
HXDLIN( 196)		if (( (bool)(this->game->__Field(HX_("paused",ae,40,84,ef),::hx::paccDynamic)) )) {
...
HXDLIN( 243)		_hx_tmp->play(::backend::Paths_obj::sound((HX_("carPass",05,1f,44,b6) + ::flixel::FlxG_obj::random->_hx_int(0,1,null())),library),((Float)0.7),null(),null(),null(),null());
HXLINE( 245)		{
