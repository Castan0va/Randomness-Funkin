...
HX_DEFINE_STACK_FRAME(_hx_pos_8e23e7423f533d70_608_new,"states.SongMetadata","new",0x9038fc22,"states.SongMetadata.new","states/FreeplayState.hx",608,0x1b2e20da)
namespace states{

void SongMetadata_obj::__construct(::String song,int week,::String songCharacter,int color){
            	HX_STACKFRAME(&_hx_pos_8e23e7423f533d70_608_new)
HXLINE( 615)		this->lastDifficulty = null();
HXLINE( 614)		this->folder = HX_("",00,00,00,00);
HXLINE( 613)		this->color = -7179779;
HXLINE( 612)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 611)		this->week = 0;
HXLINE( 610)		this->songName = HX_("",00,00,00,00);
HXLINE( 619)		this->songName = song;
HXLINE( 620)		this->week = week;
HXLINE( 621)		this->songCharacter = songCharacter;
HXLINE( 622)		this->color = color;
HXLINE( 623)		this->folder = ::backend::Mods_obj::currentModDirectory;
HXLINE( 624)		if (::hx::IsNull( this->folder )) {
HXLINE( 624)			this->folder = HX_("",00,00,00,00);
            		}
            	}
