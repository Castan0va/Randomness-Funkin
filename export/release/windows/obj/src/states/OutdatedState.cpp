...
HXLINE(  24)				int _hx_tmp1 = ::flixel::FlxG_obj::width;
HXDLIN(  24)				_this->set_x(((( (Float)(_hx_tmp1) ) - _this->get_width()) / ( (Float)(2) )));
            			}
...
HXLINE(  24)				int _hx_tmp3 = ::flixel::FlxG_obj::height;
HXDLIN(  24)				_this->set_y(((( (Float)(_hx_tmp3) ) - _this->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXLINE(  33)				{
HXLINE(  33)					::String url = HX_("https://github.com/ShadowMario/FNF-PsychEngine/releases",a2,77,06,8f);
HXDLIN(  33)					if (!( ::EReg_obj::__alloc( HX_CTX ,HX_("^.\\w+?:/*",16,3c,ef,2d),HX_("",00,00,00,00))->match(url))) {
HXLINE(  33)						url = (HX_("https://",cf,b4,ae,3e) + url);
            					}
HXDLIN(  33)					::openfl::Lib_obj::getURL( ::openfl::net::URLRequest_obj::__alloc( HX_CTX ,url),HX_("_blank",95,26,d9,b0));
            				}
            			}
            			else {
