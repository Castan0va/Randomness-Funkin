...
HX_DEFINE_STACK_FRAME(_hx_pos_a49218e3c891c30f_265_new,"states.MultiCallback","new",0x08bd2704,"states.MultiCallback.new","states/LoadingState.hx",265,0x41b125bc)
HX_LOCAL_STACK_FRAME(_hx_pos_a49218e3c891c30f_289_add,"states.MultiCallback","add",0x08b348c5,"states.MultiCallback.add","states/LoadingState.hx",289,0x41b125bc)
HX_LOCAL_STACK_FRAME(_hx_pos_a49218e3c891c30f_282_add,"states.MultiCallback","add",0x08b348c5,"states.MultiCallback.add","states/LoadingState.hx",282,0x41b125bc)
HX_LOCAL_STACK_FRAME(_hx_pos_a49218e3c891c30f_314_log,"states.MultiCallback","log",0x08bbab28,"states.MultiCallback.log","states/LoadingState.hx",314,0x41b125bc)
HX_LOCAL_STACK_FRAME(_hx_pos_a49218e3c891c30f_318_getFired,"states.MultiCallback","getFired",0x7efa9254,"states.MultiCallback.getFired","states/LoadingState.hx",318,0x41b125bc)
HX_LOCAL_STACK_FRAME(_hx_pos_a49218e3c891c30f_319_getUnfired,"states.MultiCallback","getUnfired",0xa9ee6edb,"states.MultiCallback.getUnfired","states/LoadingState.hx",319,0x41b125bc)
namespace states{

void MultiCallback_obj::__construct( ::Dynamic callback,::String logId){
            	HX_GC_STACKFRAME(&_hx_pos_a49218e3c891c30f_265_new)
...
bool MultiCallback_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic MultiCallback_obj::add(::String __o_id){
            		...
            		void _hx_run(){
            			HX_STACKFRAME(&_hx_pos_a49218e3c891c30f_289_add)
...
HXLINE( 296)						::haxe::Log_obj::trace((((HX_("",00,00,00,00) + _gthis->logId) + HX_(": ",a6,32,00,00)) + ((((HX_("fired ",72,04,21,89) + id1->__get(0)) + HX_(", ",74,26,00,00)) + _gthis->numRemaining) + HX_(" remaining",d6,c2,10,c5))),::hx::SourceInfo(HX_("source/states/LoadingState.hx",b0,0b,1c,f1),315,HX_("states.MultiCallback",12,95,5c,7a),HX_("log",84,54,52,00)));
            					}
            				}
HXLINE( 298)				if ((_gthis->numRemaining == 0)) {
HXLINE( 300)					if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 301)						if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 301)							::haxe::Log_obj::trace((((HX_("",00,00,00,00) + _gthis->logId) + HX_(": ",a6,32,00,00)) + HX_("all callbacks fired",5d,d8,ec,82)),::hx::SourceInfo(HX_("source/states/LoadingState.hx",b0,0b,1c,f1),315,HX_("states.MultiCallback",12,95,5c,7a),HX_("log",84,54,52,00)));
            						}
            					}
...
HXLINE( 306)					::haxe::Log_obj::trace((((HX_("",00,00,00,00) + _gthis->logId) + HX_(": ",a6,32,00,00)) + (HX_("already fired ",fa,e7,0c,57) + id1->__get(0))),::hx::SourceInfo(HX_("source/states/LoadingState.hx",b0,0b,1c,f1),315,HX_("states.MultiCallback",12,95,5c,7a),HX_("log",84,54,52,00)));
            				}
            			}
            		}
            	...
            	HX_STACKFRAME(&_hx_pos_a49218e3c891c30f_282_add)
HXDLIN( 282)		::Array< ::String > id1 = ::Array_obj< ::String >::__new(1)->init(0,id);
HXDLIN( 282)		 ::states::MultiCallback _gthis = ::hx::ObjectPtr<OBJ_>(this);
...
void MultiCallback_obj::log(::String msg){
            	HX_STACKFRAME(&_hx_pos_a49218e3c891c30f_314_log)
HXDLIN( 314)		if (::hx::IsNotNull( this->logId )) {
HXLINE( 315)			::haxe::Log_obj::trace((((HX_("",00,00,00,00) + this->logId) + HX_(": ",a6,32,00,00)) + msg),::hx::SourceInfo(HX_("source/states/LoadingState.hx",b0,0b,1c,f1),315,HX_("states.MultiCallback",12,95,5c,7a),HX_("log",84,54,52,00)));
            		}
            	}
...
::Array< ::String > MultiCallback_obj::getFired(){
            	HX_STACKFRAME(&_hx_pos_a49218e3c891c30f_318_getFired)
...
::Array< ::String > MultiCallback_obj::getUnfired(){
            	HX_STACKFRAME(&_hx_pos_a49218e3c891c30f_319_getUnfired)
