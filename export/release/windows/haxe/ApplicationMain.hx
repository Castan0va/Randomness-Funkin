...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Random", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("Random", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		#elseif air
		app.window.title = "Randomness Funkin";
		#else
